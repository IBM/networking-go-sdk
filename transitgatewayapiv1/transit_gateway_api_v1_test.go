...
package transitgatewayapiv1_test
...
import (
	...
	"github.ibm.com/ibmcloud/networking-go-sdk/transitgatewayapiv1"
)

var _ = Describe(`TransitGatewayApiV1`, func() {
	var testServer *httptest.Server
	Describe(`Service constructor tests`, func() {
		version := "testString"
		It(`Instantiate service client`, func() {
			transitGatewayApiService, serviceErr := transitgatewayapiv1.NewTransitGatewayApiV1(&transitgatewayapiv1.TransitGatewayApiV1Options{
				Authenticator: &core.NoAuthAuthenticator{},
				Version: core.StringPtr(version),
			})
			Expect(transitGatewayApiService).ToNot(BeNil())
		...
		It(`Instantiate service client with error: Invalid URL`, func() {
			...
			Expect(transitGatewayApiService).To(BeNil())
			Expect(serviceErr).ToNot(BeNil())
		})
		It(`Instantiate service client with error: Invalid Auth`, func() {
			transitGatewayApiService, serviceErr := transitgatewayapiv1.NewTransitGatewayApiV1(&transitgatewayapiv1.TransitGatewayApiV1Options{
				URL: "https://transitgatewayapiv1/api",
				Version: core.StringPtr(version),
	...
	Describe(`Service constructor tests using external config`, func() {
		...
		Context(`Using external config, construct service client instances`, func() {
			...
			var testEnvironment = map[string]string{
				"TRANSIT_GATEWAY_API_URL": "https://transitgatewayapiv1/api",
				"TRANSIT_GATEWAY_API_AUTH_TYPE": "noauth",
			}

			It(`Create service client using external config successfully`, func() {
				SetTestEnvironment(testEnvironment)
				transitGatewayApiService, serviceErr := transitgatewayapiv1.NewTransitGatewayApiV1UsingExternalConfig(&transitgatewayapiv1.TransitGatewayApiV1Options{
					Version: core.StringPtr(version),
				})
				Expect(transitGatewayApiService).ToNot(BeNil())
				Expect(serviceErr).To(BeNil())
				...
				clone := transitGatewayApiService.Clone()
				Expect(clone).ToNot(BeNil())
				Expect(clone.Service != transitGatewayApiService.Service).To(BeTrue())
				Expect(clone.GetServiceURL()).To(Equal(transitGatewayApiService.GetServiceURL()))
				Expect(clone.Service.Options.Authenticator).To(Equal(transitGatewayApiService.Service.Options.Authenticator))
			})
			It(`Create service client using external config and set url from constructor successfully`, func() {
				...
				Expect(transitGatewayApiService).ToNot(BeNil())
				Expect(serviceErr).To(BeNil())
				Expect(transitGatewayApiService.Service.GetServiceURL()).To(Equal("https://testService/api"))
				ClearTestEnvironment(testEnvironment)
			...
			It(`Create service client using external config and set url programatically successfully`, func() {
				...
				err := transitGatewayApiService.SetServiceURL("https://testService/api")
				Expect(err).To(BeNil())
				Expect(transitGatewayApiService).ToNot(BeNil())
				Expect(serviceErr).To(BeNil())
				Expect(transitGatewayApiService.Service.GetServiceURL()).To(Equal("https://testService/api"))
		...
		Context(`Using external config, construct service client instances with error: Invalid Auth`, func() {
			...
			var testEnvironment = map[string]string{
				"TRANSIT_GATEWAY_API_URL": "https://transitgatewayapiv1/api",
				"TRANSIT_GATEWAY_API_AUTH_TYPE": "someOtherAuth",
			}
	...
	Describe(`Regional endpoint tests`, func() {
		It(`GetServiceURLForRegion(region string)`, func() {
			var url string
			var err error
			url, err = transitgatewayapiv1.GetServiceURLForRegion("INVALID_REGION")
	...
	Describe(`ListTransitGateways(listTransitGatewaysOptions *ListTransitGatewaysOptions) - Operation response error`, func() {
		...
		Context(`Using mock server endpoint with invalid JSON response`, func() {
			...
			It(`Invoke ListTransitGateways with error: Operation response processing error`, func() {
				...
				listTransitGatewaysOptionsModel := new(transitgatewayapiv1.ListTransitGatewaysOptions)
				...
				result, response, operationErr := transitGatewayApiService.ListTransitGateways(listTransitGatewaysOptionsModel)
				Expect(operationErr).ToNot(BeNil())
				Expect(response).ToNot(BeNil())
				Expect(result).To(BeNil())

				// Enable retries and test again
				transitGatewayApiService.EnableRetries(0, 0)
				result, response, operationErr = transitGatewayApiService.ListTransitGateways(listTransitGatewaysOptionsModel)
				Expect(operationErr).ToNot(BeNil())
				Expect(response).ToNot(BeNil())
				Expect(result).To(BeNil())
	...
	Describe(`ListTransitGateways(listTransitGatewaysOptions *ListTransitGatewaysOptions)`, func() {
		...
		Context(`Using mock server endpoint with timeout`, func() {
			...
			It(`Invoke ListTransitGateways successfully with retries`, func() {
				...
				defer cancelFunc()
				_, _, operationErr := transitGatewayApiService.ListTransitGatewaysWithContext(ctx, listTransitGatewaysOptionsModel)
				Expect(operationErr).ToNot(BeNil())
		...
		Context(`Using mock server endpoint`, func() {
			...
			It(`Invoke ListTransitGateways successfully`, func() {
				...
				result, response, operationErr := transitGatewayApiService.ListTransitGateways(nil)
			...
			It(`Invoke ListTransitGateways with error: Operation request error`, func() {
				...
				err := transitGatewayApiService.SetServiceURL("")
				Expect(err).To(BeNil())
				result, response, operationErr := transitGatewayApiService.ListTransitGateways(listTransitGatewaysOptionsModel)
				Expect(operationErr).ToNot(BeNil())
		...
		Context(`Test pagination helper method on response`, func() {
			It(`Invoke GetNextStart successfully`, func() {
				responseObject := new(transitgatewayapiv1.TransitGatewayCollection)
				nextObject := new(transitgatewayapiv1.PaginationNextTG)
		...
		Context(`Using mock server endpoint - paginated response`, func() {
			BeforeEach(func() {
				...
				testServer = httptest.NewServer(http.HandlerFunc(func(res http.ResponseWriter, req *http.Request) {
					...
					requestNumber++
					if requestNumber == 1 {
						fmt.Fprintf(res, "%s", `{"next":{"start":"1"},"transit_gateways":[{"allow_gre_traffic_across_zones":true,"connection_count":5,"connection_needs_attention":true,"created_at":"2019-01-01T12:00:00.000Z","crn":"crn:v1:bluemix:public:transit:dal03:a/57a7d05f36894e3cb9b46a43556d903e::gateway:ef4dcb1a-fee4-41c7-9e11-9cd99e65c1f4","global":true,"id":"0a06fb9b-820f-4c44-8a31-77f1f0806d28","location":"us-south","name":"my-transit-gateway-in-TransitGateway","resource_group":{"href":"https://resource-manager.bluemix.net/v1/resource_groups/56969d6043e9465c883cb9f7363e78e8","id":"56969d6043e9465c883cb9f7363e78e8"},"status":"available","updated_at":"2019-01-01T12:00:00.000Z"}],"total_count":2,"limit":1}`)
					} else if requestNumber == 2 {
						fmt.Fprintf(res, "%s", `{"transit_gateways":[{"allow_gre_traffic_across_zones":true,"connection_count":5,"connection_needs_attention":true,"created_at":"2019-01-01T12:00:00.000Z","crn":"crn:v1:bluemix:public:transit:dal03:a/57a7d05f36894e3cb9b46a43556d903e::gateway:ef4dcb1a-fee4-41c7-9e11-9cd99e65c1f4","global":true,"id":"0a06fb9b-820f-4c44-8a31-77f1f0806d28","location":"us-south","name":"my-transit-gateway-in-TransitGateway","resource_group":{"href":"https://resource-manager.bluemix.net/v1/resource_groups/56969d6043e9465c883cb9f7363e78e8","id":"56969d6043e9465c883cb9f7363e78e8"},"status":"available","updated_at":"2019-01-01T12:00:00.000Z"}],"total_count":2,"limit":1}`)
					} else {
						res.WriteHeader(400)
					}
				}))
			...
			It(`Use TransitGatewaysPager.GetNext successfully`, func() {
				...
				listTransitGatewaysOptionsModel := &transitgatewayapiv1.ListTransitGatewaysOptions{
					Limit: core.Int64Ptr(int64(10)),
				}

				pager, err := transitGatewayApiService.NewTransitGatewaysPager(listTransitGatewaysOptionsModel)
				Expect(err).To(BeNil())
				Expect(pager).ToNot(BeNil())

				var allResults []transitgatewayapiv1.TransitGateway
				for pager.HasNext() {
	...
	Describe(`CreateTransitGateway(createTransitGatewayOptions *CreateTransitGatewayOptions) - Operation response error`, func() {
		...
		Context(`Using mock server endpoint with invalid JSON response`, func() {
			...
			It(`Invoke CreateTransitGateway with error: Operation response processing error`, func() {
				...
				resourceGroupIdentityModel := new(transitgatewayapiv1.ResourceGroupIdentity)
				...
				createTransitGatewayOptionsModel := new(transitgatewayapiv1.CreateTransitGatewayOptions)
				createTransitGatewayOptionsModel.AllowGreTrafficAcrossZones = core.BoolPtr(true)
				...
				// Expect response parsing to fail since we are receiving a text/plain response
				result, response, operationErr := transitGatewayApiService.CreateTransitGateway(createTransitGatewayOptionsModel)
				Expect(operationErr).ToNot(BeNil())
				Expect(response).ToNot(BeNil())
				Expect(result).To(BeNil())
	...
	Describe(`CreateTransitGateway(createTransitGatewayOptions *CreateTransitGatewayOptions)`, func() {
		...
		Context(`Using mock server endpoint with timeout`, func() {
			BeforeEach(func() {
				testServer = httptest.NewServer(http.HandlerFunc(func(res http.ResponseWriter, req *http.Request) {
					...
					res.Header().Set("Content-type", "application/json")
					res.WriteHeader(201)
					fmt.Fprintf(res, "%s", `{"allow_gre_traffic_across_zones": true, "connection_count": 5, "connection_needs_attention": true, "created_at": "2019-01-01T12:00:00.000Z", "crn": "crn:v1:bluemix:public:transit:dal03:a/57a7d05f36894e3cb9b46a43556d903e::gateway:ef4dcb1a-fee4-41c7-9e11-9cd99e65c1f4", "global": true, "id": "0a06fb9b-820f-4c44-8a31-77f1f0806d28", "location": "us-south", "name": "my-transit-gateway-in-TransitGateway", "resource_group": {"href": "https://resource-manager.bluemix.net/v1/resource_groups/56969d6043e9465c883cb9f7363e78e8", "id": "56969d6043e9465c883cb9f7363e78e8"}, "status": "available", "updated_at": "2019-01-01T12:00:00.000Z"}`)
				}))
			})
			It(`Invoke CreateTransitGateway successfully with retries`, func() {
				...
				ctx, cancelFunc := context.WithTimeout(context.Background(), 80*time.Millisecond)
				defer cancelFunc()
				_, _, operationErr := transitGatewayApiService.CreateTransitGatewayWithContext(ctx, createTransitGatewayOptionsModel)
				Expect(operationErr).ToNot(BeNil())
				Expect(operationErr.Error()).To(ContainSubstring("deadline exceeded"))
		...
		Context(`Using mock server endpoint`, func() {
			...
			It(`Invoke CreateTransitGateway successfully`, func() {
				...
				// Invoke operation with nil options model (negative test)
				result, response, operationErr := transitGatewayApiService.CreateTransitGateway(nil)
				Expect(operationErr).NotTo(BeNil())
				Expect(response).To(BeNil())
				Expect(result).To(BeNil())
			...
			It(`Invoke CreateTransitGateway with error: Operation request error`, func() {
				transitGatewayApiService, serviceErr := transitgatewayapiv1.NewTransitGatewayApiV1(&transitgatewayapiv1.TransitGatewayApiV1Options{
					URL:           testServer.URL,
					Authenticator: &core.NoAuthAuthenticator{},
					Version: core.StringPtr(version),
	...
	Describe(`DeleteTransitGateway(deleteTransitGatewayOptions *DeleteTransitGatewayOptions)`, func() {
		...
		Context(`Using mock server endpoint`, func() {
			...
			It(`Invoke DeleteTransitGateway successfully`, func() {
				...
				// Invoke operation with nil options model (negative test)
				response, operationErr := transitGatewayApiService.DeleteTransitGateway(nil)
				Expect(operationErr).NotTo(BeNil())
				Expect(response).To(BeNil())

				// Construct an instance of the DeleteTransitGatewayOptions model
				deleteTransitGatewayOptionsModel := new(transitgatewayapiv1.DeleteTransitGatewayOptions)
				...
				// Invoke operation with valid options model (positive test)
				response, operationErr = transitGatewayApiService.DeleteTransitGateway(deleteTransitGatewayOptionsModel)
				Expect(operationErr).To(BeNil())
				Expect(response).ToNot(BeNil())
			})
			It(`Invoke DeleteTransitGateway with error: Operation validation and request error`, func() {
				...
				deleteTransitGatewayOptionsModelNew := new(transitgatewayapiv1.DeleteTransitGatewayOptions)
				// Invoke operation with invalid model (negative test)
				response, operationErr = transitGatewayApiService.DeleteTransitGateway(deleteTransitGatewayOptionsModelNew)
				Expect(operationErr).ToNot(BeNil())
				Expect(response).To(BeNil())
			})
			AfterEach(func() {
	...
	Describe(`GetTransitGateway(getTransitGatewayOptions *GetTransitGatewayOptions) - Operation response error`, func() {
		...
		Context(`Using mock server endpoint with invalid JSON response`, func() {
			...
			It(`Invoke GetTransitGateway with error: Operation response processing error`, func() {
				...
				getTransitGatewayOptionsModel := new(transitgatewayapiv1.GetTransitGatewayOptions)
				...
				// Expect response parsing to fail since we are receiving a text/plain response
				result, response, operationErr := transitGatewayApiService.GetTransitGateway(getTransitGatewayOptionsModel)
				Expect(operationErr).ToNot(BeNil())
				Expect(response).ToNot(BeNil())
				Expect(result).To(BeNil())
	...
	Describe(`GetTransitGateway(getTransitGatewayOptions *GetTransitGatewayOptions)`, func() {
		...
		Context(`Using mock server endpoint with timeout`, func() {
			...
			It(`Invoke GetTransitGateway successfully with retries`, func() {
				...
				ctx, cancelFunc := context.WithTimeout(context.Background(), 80*time.Millisecond)
				defer cancelFunc()
				_, _, operationErr := transitGatewayApiService.GetTransitGatewayWithContext(ctx, getTransitGatewayOptionsModel)
				Expect(operationErr).ToNot(BeNil())
				Expect(operationErr.Error()).To(ContainSubstring("deadline exceeded"))
		...
		Context(`Using mock server endpoint`, func() {
			...
			It(`Invoke GetTransitGateway successfully`, func() {
				...
				// Invoke operation with nil options model (negative test)
				result, response, operationErr := transitGatewayApiService.GetTransitGateway(nil)
				Expect(operationErr).NotTo(BeNil())
				Expect(response).To(BeNil())
				Expect(result).To(BeNil())
			...
			It(`Invoke GetTransitGateway with error: Operation validation and request error`, func() {
				...
				getTransitGatewayOptionsModelNew := new(transitgatewayapiv1.GetTransitGatewayOptions)
				// Invoke operation with invalid model (negative test)
				result, response, operationErr = transitGatewayApiService.GetTransitGateway(getTransitGatewayOptionsModelNew)
				Expect(operationErr).ToNot(BeNil())
				Expect(response).To(BeNil())
				Expect(result).To(BeNil())
			})
	...
	Describe(`UpdateTransitGateway(updateTransitGatewayOptions *UpdateTransitGatewayOptions) - Operation response error`, func() {
		...
		Context(`Using mock server endpoint with invalid JSON response`, func() {
			...
			It(`Invoke UpdateTransitGateway with error: Operation response processing error`, func() {
				...
				updateTransitGatewayOptionsModel := new(transitgatewayapiv1.UpdateTransitGatewayOptions)
				updateTransitGatewayOptionsModel.ID = core.StringPtr("testString")
				updateTransitGatewayOptionsModel.AllowGreTrafficAcrossZones = core.BoolPtr(true)
				...
				// Expect response parsing to fail since we are receiving a text/plain response
				result, response, operationErr := transitGatewayApiService.UpdateTransitGateway(updateTransitGatewayOptionsModel)
				Expect(operationErr).ToNot(BeNil())
				Expect(response).ToNot(BeNil())
				Expect(result).To(BeNil())
	...
	Describe(`UpdateTransitGateway(updateTransitGatewayOptions *UpdateTransitGatewayOptions)`, func() {
		...
		Context(`Using mock server endpoint with timeout`, func() {
			...
			It(`Invoke UpdateTransitGateway successfully with retries`, func() {
				...
				ctx, cancelFunc := context.WithTimeout(context.Background(), 80*time.Millisecond)
				defer cancelFunc()
				_, _, operationErr := transitGatewayApiService.UpdateTransitGatewayWithContext(ctx, updateTransitGatewayOptionsModel)
				Expect(operationErr).ToNot(BeNil())
				Expect(operationErr.Error()).To(ContainSubstring("deadline exceeded"))
		...
		Context(`Using mock server endpoint`, func() {
			...
			It(`Invoke UpdateTransitGateway successfully`, func() {
				...
				// Invoke operation with nil options model (negative test)
				result, response, operationErr := transitGatewayApiService.UpdateTransitGateway(nil)
				Expect(operationErr).NotTo(BeNil())
				Expect(response).To(BeNil())
				Expect(result).To(BeNil())
			...
			It(`Invoke UpdateTransitGateway with error: Operation validation and request error`, func() {
				...
				updateTransitGatewayOptionsModelNew := new(transitgatewayapiv1.UpdateTransitGatewayOptions)
				// Invoke operation with invalid model (negative test)
				result, response, operationErr = transitGatewayApiService.UpdateTransitGateway(updateTransitGatewayOptionsModelNew)
				Expect(operationErr).ToNot(BeNil())
				Expect(response).To(BeNil())
				Expect(result).To(BeNil())
			})
	...
	Describe(`ListConnections(listConnectionsOptions *ListConnectionsOptions) - Operation response error`, func() {
		...
		Context(`Using mock server endpoint with invalid JSON response`, func() {
			...
			It(`Invoke ListConnections with error: Operation response processing error`, func() {
				...
				listConnectionsOptionsModel := new(transitgatewayapiv1.ListConnectionsOptions)
				...
				// Expect response parsing to fail since we are receiving a text/plain response
				result, response, operationErr := transitGatewayApiService.ListConnections(listConnectionsOptionsModel)
				Expect(operationErr).ToNot(BeNil())
				Expect(response).ToNot(BeNil())
				Expect(result).To(BeNil())
	...
	Describe(`ListConnections(listConnectionsOptions *ListConnectionsOptions)`, func() {
		...
		Context(`Using mock server endpoint with timeout`, func() {
			...
			It(`Invoke ListConnections successfully with retries`, func() {
				...
				ctx, cancelFunc := context.WithTimeout(context.Background(), 80*time.Millisecond)
				defer cancelFunc()
				_, _, operationErr := transitGatewayApiService.ListConnectionsWithContext(ctx, listConnectionsOptionsModel)
				Expect(operationErr).ToNot(BeNil())
				Expect(operationErr.Error()).To(ContainSubstring("deadline exceeded"))
		...
		Context(`Using mock server endpoint`, func() {
			...
			It(`Invoke ListConnections successfully`, func() {
				...
				// Invoke operation with nil options model (negative test)
				result, response, operationErr := transitGatewayApiService.ListConnections(nil)
				Expect(operationErr).NotTo(BeNil())
				Expect(response).To(BeNil())
				Expect(result).To(BeNil())
		...
		Context(`Test pagination helper method on response`, func() {
			It(`Invoke GetNextStart successfully`, func() {
				responseObject := new(transitgatewayapiv1.TransitConnectionCollection)
				nextObject := new(transitgatewayapiv1.PaginationNextConnection)
				nextObject.Start = core.StringPtr("abc-123")
				responseObject.Next = nextObject
		...
		Context(`Using mock server endpoint - paginated response`, func() {
			...
			It(`Use ConnectionsPager.GetNext successfully`, func() {
				...
				listConnectionsOptionsModel := &transitgatewayapiv1.ListConnectionsOptions{
					Limit: core.Int64Ptr(int64(10)),
					NetworkID: core.StringPtr("testString"),
				}

				pager, err := transitGatewayApiService.NewConnectionsPager(listConnectionsOptionsModel)
				Expect(err).To(BeNil())
				Expect(pager).ToNot(BeNil())

				var allResults []transitgatewayapiv1.TransitConnection
				for pager.HasNext() {
					nextPage, err := pager.GetNext()
					Expect(err).To(BeNil())
					Expect(nextPage).ToNot(BeNil())
	...
	Describe(`ListTransitGatewayConnections(listTransitGatewayConnectionsOptions *ListTransitGatewayConnectionsOptions) - Operation response error`, func() {
		...
		Context(`Using mock server endpoint with invalid JSON response`, func() {
			...
			It(`Invoke ListTransitGatewayConnections with error: Operation response processing error`, func() {
				...
				listTransitGatewayConnectionsOptionsModel := new(transitgatewayapiv1.ListTransitGatewayConnectionsOptions)
				...
				// Expect response parsing to fail since we are receiving a text/plain response
				result, response, operationErr := transitGatewayApiService.ListTransitGatewayConnections(listTransitGatewayConnectionsOptionsModel)
				Expect(operationErr).ToNot(BeNil())
				Expect(response).ToNot(BeNil())
				Expect(result).To(BeNil())
	...
	Describe(`ListTransitGatewayConnections(listTransitGatewayConnectionsOptions *ListTransitGatewayConnectionsOptions)`, func() {
		...
		Context(`Using mock server endpoint with timeout`, func() {
			...
			It(`Invoke ListTransitGatewayConnections successfully with retries`, func() {
				...
				ctx, cancelFunc := context.WithTimeout(context.Background(), 80*time.Millisecond)
				defer cancelFunc()
				_, _, operationErr := transitGatewayApiService.ListTransitGatewayConnectionsWithContext(ctx, listTransitGatewayConnectionsOptionsModel)
				Expect(operationErr).ToNot(BeNil())
				Expect(operationErr.Error()).To(ContainSubstring("deadline exceeded"))
		...
		Context(`Using mock server endpoint`, func() {
			...
			It(`Invoke ListTransitGatewayConnections successfully`, func() {
				...
				// Invoke operation with nil options model (negative test)
				result, response, operationErr := transitGatewayApiService.ListTransitGatewayConnections(nil)
				Expect(operationErr).NotTo(BeNil())
				Expect(response).To(BeNil())
				Expect(result).To(BeNil())
			...
			It(`Invoke ListTransitGatewayConnections with error: Operation validation and request error`, func() {
				...
				listTransitGatewayConnectionsOptionsModelNew := new(transitgatewayapiv1.ListTransitGatewayConnectionsOptions)
				// Invoke operation with invalid model (negative test)
				result, response, operationErr = transitGatewayApiService.ListTransitGatewayConnections(listTransitGatewayConnectionsOptionsModelNew)
				Expect(operationErr).ToNot(BeNil())
				Expect(response).To(BeNil())
				Expect(result).To(BeNil())
			})
		...
		Context(`Test pagination helper method on response`, func() {
			It(`Invoke GetNextStart successfully`, func() {
				responseObject := new(transitgatewayapiv1.TransitGatewayConnectionCollection)
				nextObject := new(transitgatewayapiv1.PaginationNextTGWConnection)
				nextObject.Start = core.StringPtr("abc-123")
				responseObject.Next = nextObject
		...
		Context(`Using mock server endpoint - paginated response`, func() {
			BeforeEach(func() {
				...
				testServer = httptest.NewServer(http.HandlerFunc(func(res http.ResponseWriter, req *http.Request) {
					...
					requestNumber++
					if requestNumber == 1 {
						fmt.Fprintf(res, "%s", `{"next":{"start":"1"},"total_count":2,"limit":1,"connections":[{}]}`)
					} else if requestNumber == 2 {
						fmt.Fprintf(res, "%s", `{"total_count":2,"limit":1,"connections":[{}]}`)
					} else {
						res.WriteHeader(400)
					}
				}))
			...
			It(`Use TransitGatewayConnectionsPager.GetNext successfully`, func() {
				...
				listTransitGatewayConnectionsOptionsModel := &transitgatewayapiv1.ListTransitGatewayConnectionsOptions{
					TransitGatewayID: core.StringPtr("testString"),
					Limit: core.Int64Ptr(int64(10)),
					Name: core.StringPtr("testString"),
				}

				pager, err := transitGatewayApiService.NewTransitGatewayConnectionsPager(listTransitGatewayConnectionsOptionsModel)
				Expect(err).To(BeNil())
				Expect(pager).ToNot(BeNil())

				var allResults []transitgatewayapiv1.TransitGatewayConnectionCust
				for pager.HasNext() {
					nextPage, err := pager.GetNext()
					Expect(err).To(BeNil())
					Expect(nextPage).ToNot(BeNil())
	...
	Describe(`CreateTransitGatewayConnection(createTransitGatewayConnectionOptions *CreateTransitGatewayConnectionOptions) - Operation response error`, func() {
		...
		Context(`Using mock server endpoint with invalid JSON response`, func() {
			...
			It(`Invoke CreateTransitGatewayConnection with error: Operation response processing error`, func() {
				...
				transitGatewayConnectionPrefixFilterModel := new(transitgatewayapiv1.TransitGatewayConnectionPrefixFilter)
				...
				zoneIdentityModel := new(transitgatewayapiv1.ZoneIdentityByName)
				zoneIdentityModel.Name = core.StringPtr("us-south-1")

				// Construct an instance of the TransitGatewayTunnelTemplate model
				transitGatewayTunnelTemplateModel := new(transitgatewayapiv1.TransitGatewayTunnelTemplate)
				...
				createTransitGatewayConnectionOptionsModel := new(transitgatewayapiv1.CreateTransitGatewayConnectionOptions)
				...
				createTransitGatewayConnectionOptionsModel.PrefixFilters = []transitgatewayapiv1.TransitGatewayConnectionPrefixFilter{*transitGatewayConnectionPrefixFilterModel}
				...
				createTransitGatewayConnectionOptionsModel.Tunnels = []transitgatewayapiv1.TransitGatewayTunnelTemplate{*transitGatewayTunnelTemplateModel}
				...
				// Expect response parsing to fail since we are receiving a text/plain response
				result, response, operationErr := transitGatewayApiService.CreateTransitGatewayConnection(createTransitGatewayConnectionOptionsModel)
				Expect(operationErr).ToNot(BeNil())
				Expect(response).ToNot(BeNil())
				Expect(result).To(BeNil())
	...
	Describe(`CreateTransitGatewayConnection(createTransitGatewayConnectionOptions *CreateTransitGatewayConnectionOptions)`, func() {
		...
		Context(`Using mock server endpoint with timeout`, func() {
			...
			It(`Invoke CreateTransitGatewayConnection successfully with retries`, func() {
				...
				ctx, cancelFunc := context.WithTimeout(context.Background(), 80*time.Millisecond)
				defer cancelFunc()
				_, _, operationErr := transitGatewayApiService.CreateTransitGatewayConnectionWithContext(ctx, createTransitGatewayConnectionOptionsModel)
				Expect(operationErr).ToNot(BeNil())
				Expect(operationErr.Error()).To(ContainSubstring("deadline exceeded"))
		...
		Context(`Using mock server endpoint`, func() {
			...
			It(`Invoke CreateTransitGatewayConnection successfully`, func() {
				...
				// Invoke operation with nil options model (negative test)
				result, response, operationErr := transitGatewayApiService.CreateTransitGatewayConnection(nil)
				Expect(operationErr).NotTo(BeNil())
				Expect(response).To(BeNil())
				Expect(result).To(BeNil())
			...
			It(`Invoke CreateTransitGatewayConnection with error: Operation validation and request error`, func() {
				...
				createTransitGatewayConnectionOptionsModelNew := new(transitgatewayapiv1.CreateTransitGatewayConnectionOptions)
				// Invoke operation with invalid model (negative test)
				result, response, operationErr = transitGatewayApiService.CreateTransitGatewayConnection(createTransitGatewayConnectionOptionsModelNew)
				Expect(operationErr).ToNot(BeNil())
				Expect(response).To(BeNil())
				Expect(result).To(BeNil())
			})
	...
	Describe(`DeleteTransitGatewayConnection(deleteTransitGatewayConnectionOptions *DeleteTransitGatewayConnectionOptions)`, func() {
		...
		Context(`Using mock server endpoint`, func() {
			...
			It(`Invoke DeleteTransitGatewayConnection successfully`, func() {
				...
				// Invoke operation with nil options model (negative test)
				response, operationErr := transitGatewayApiService.DeleteTransitGatewayConnection(nil)
				Expect(operationErr).NotTo(BeNil())
				Expect(response).To(BeNil())

				// Construct an instance of the DeleteTransitGatewayConnectionOptions model
				deleteTransitGatewayConnectionOptionsModel := new(transitgatewayapiv1.DeleteTransitGatewayConnectionOptions)
				...
				// Invoke operation with valid options model (positive test)
				response, operationErr = transitGatewayApiService.DeleteTransitGatewayConnection(deleteTransitGatewayConnectionOptionsModel)
				Expect(operationErr).To(BeNil())
				Expect(response).ToNot(BeNil())
			})
			It(`Invoke DeleteTransitGatewayConnection with error: Operation validation and request error`, func() {
				...
				deleteTransitGatewayConnectionOptionsModelNew := new(transitgatewayapiv1.DeleteTransitGatewayConnectionOptions)
				// Invoke operation with invalid model (negative test)
				response, operationErr = transitGatewayApiService.DeleteTransitGatewayConnection(deleteTransitGatewayConnectionOptionsModelNew)
				Expect(operationErr).ToNot(BeNil())
				Expect(response).To(BeNil())
			})
			AfterEach(func() {
	...
	Describe(`GetTransitGatewayConnection(getTransitGatewayConnectionOptions *GetTransitGatewayConnectionOptions) - Operation response error`, func() {
		...
		Context(`Using mock server endpoint with invalid JSON response`, func() {
			...
			It(`Invoke GetTransitGatewayConnection with error: Operation response processing error`, func() {
				...
				getTransitGatewayConnectionOptionsModel := new(transitgatewayapiv1.GetTransitGatewayConnectionOptions)
				...
				// Expect response parsing to fail since we are receiving a text/plain response
				result, response, operationErr := transitGatewayApiService.GetTransitGatewayConnection(getTransitGatewayConnectionOptionsModel)
				Expect(operationErr).ToNot(BeNil())
				Expect(response).ToNot(BeNil())
				Expect(result).To(BeNil())
	...
	Describe(`GetTransitGatewayConnection(getTransitGatewayConnectionOptions *GetTransitGatewayConnectionOptions)`, func() {
		...
		Context(`Using mock server endpoint with timeout`, func() {
			...
			It(`Invoke GetTransitGatewayConnection successfully with retries`, func() {
				...
				ctx, cancelFunc := context.WithTimeout(context.Background(), 80*time.Millisecond)
				defer cancelFunc()
				_, _, operationErr := transitGatewayApiService.GetTransitGatewayConnectionWithContext(ctx, getTransitGatewayConnectionOptionsModel)
				Expect(operationErr).ToNot(BeNil())
				Expect(operationErr.Error()).To(ContainSubstring("deadline exceeded"))
		...
		Context(`Using mock server endpoint`, func() {
			...
			It(`Invoke GetTransitGatewayConnection successfully`, func() {
				...
				// Invoke operation with nil options model (negative test)
				result, response, operationErr := transitGatewayApiService.GetTransitGatewayConnection(nil)
				Expect(operationErr).NotTo(BeNil())
				Expect(response).To(BeNil())
				Expect(result).To(BeNil())
			...
			It(`Invoke GetTransitGatewayConnection with error: Operation validation and request error`, func() {
				...
				getTransitGatewayConnectionOptionsModelNew := new(transitgatewayapiv1.GetTransitGatewayConnectionOptions)
				// Invoke operation with invalid model (negative test)
				result, response, operationErr = transitGatewayApiService.GetTransitGatewayConnection(getTransitGatewayConnectionOptionsModelNew)
				Expect(operationErr).ToNot(BeNil())
				Expect(response).To(BeNil())
				Expect(result).To(BeNil())
			})
	...
	Describe(`UpdateTransitGatewayConnection(updateTransitGatewayConnectionOptions *UpdateTransitGatewayConnectionOptions) - Operation response error`, func() {
		...
		Context(`Using mock server endpoint with invalid JSON response`, func() {
			...
			It(`Invoke UpdateTransitGatewayConnection with error: Operation response processing error`, func() {
				...
				updateTransitGatewayConnectionOptionsModel := new(transitgatewayapiv1.UpdateTransitGatewayConnectionOptions)
				...
				// Expect response parsing to fail since we are receiving a text/plain response
				result, response, operationErr := transitGatewayApiService.UpdateTransitGatewayConnection(updateTransitGatewayConnectionOptionsModel)
				Expect(operationErr).ToNot(BeNil())
				Expect(response).ToNot(BeNil())
				Expect(result).To(BeNil())
	...
	Describe(`UpdateTransitGatewayConnection(updateTransitGatewayConnectionOptions *UpdateTransitGatewayConnectionOptions)`, func() {
		...
		Context(`Using mock server endpoint with timeout`, func() {
			...
			It(`Invoke UpdateTransitGatewayConnection successfully with retries`, func() {
				...
				ctx, cancelFunc := context.WithTimeout(context.Background(), 80*time.Millisecond)
				defer cancelFunc()
				_, _, operationErr := transitGatewayApiService.UpdateTransitGatewayConnectionWithContext(ctx, updateTransitGatewayConnectionOptionsModel)
				Expect(operationErr).ToNot(BeNil())
				Expect(operationErr.Error()).To(ContainSubstring("deadline exceeded"))
		...
		Context(`Using mock server endpoint`, func() {
			...
			It(`Invoke UpdateTransitGatewayConnection successfully`, func() {
				...
				// Invoke operation with nil options model (negative test)
				result, response, operationErr := transitGatewayApiService.UpdateTransitGatewayConnection(nil)
				Expect(operationErr).NotTo(BeNil())
				Expect(response).To(BeNil())
				Expect(result).To(BeNil())
			...
			It(`Invoke UpdateTransitGatewayConnection with error: Operation validation and request error`, func() {
				...
				updateTransitGatewayConnectionOptionsModelNew := new(transitgatewayapiv1.UpdateTransitGatewayConnectionOptions)
				// Invoke operation with invalid model (negative test)
				result, response, operationErr = transitGatewayApiService.UpdateTransitGatewayConnection(updateTransitGatewayConnectionOptionsModelNew)
				Expect(operationErr).ToNot(BeNil())
				Expect(response).To(BeNil())
				Expect(result).To(BeNil())
			})
	...
	Describe(`CreateTransitGatewayConnectionActions(createTransitGatewayConnectionActionsOptions *CreateTransitGatewayConnectionActionsOptions)`, func() {
		...
		Context(`Using mock server endpoint`, func() {
			...
			It(`Invoke CreateTransitGatewayConnectionActions successfully`, func() {
				...
				// Invoke operation with nil options model (negative test)
				response, operationErr := transitGatewayApiService.CreateTransitGatewayConnectionActions(nil)
				Expect(operationErr).NotTo(BeNil())
				Expect(response).To(BeNil())

				// Construct an instance of the CreateTransitGatewayConnectionActionsOptions model
				createTransitGatewayConnectionActionsOptionsModel := new(transitgatewayapiv1.CreateTransitGatewayConnectionActionsOptions)
				...
				// Invoke operation with valid options model (positive test)
				response, operationErr = transitGatewayApiService.CreateTransitGatewayConnectionActions(createTransitGatewayConnectionActionsOptionsModel)
				Expect(operationErr).To(BeNil())
				Expect(response).ToNot(BeNil())
			})
			It(`Invoke CreateTransitGatewayConnectionActions with error: Operation validation and request error`, func() {
				...
				createTransitGatewayConnectionActionsOptionsModelNew := new(transitgatewayapiv1.CreateTransitGatewayConnectionActionsOptions)
				// Invoke operation with invalid model (negative test)
				response, operationErr = transitGatewayApiService.CreateTransitGatewayConnectionActions(createTransitGatewayConnectionActionsOptionsModelNew)
				Expect(operationErr).ToNot(BeNil())
				Expect(response).To(BeNil())
			})
			AfterEach(func() {
	...
	Describe(`ListTransitGatewayGreTunnel(listTransitGatewayGreTunnelOptions *ListTransitGatewayGreTunnelOptions) - Operation response error`, func() {
		...
		Context(`Using mock server endpoint with invalid JSON response`, func() {
			...
			It(`Invoke ListTransitGatewayGreTunnel with error: Operation response processing error`, func() {
				...
				listTransitGatewayGreTunnelOptionsModel := new(transitgatewayapiv1.ListTransitGatewayGreTunnelOptions)
				...
				// Expect response parsing to fail since we are receiving a text/plain response
				result, response, operationErr := transitGatewayApiService.ListTransitGatewayGreTunnel(listTransitGatewayGreTunnelOptionsModel)
				Expect(operationErr).ToNot(BeNil())
				Expect(response).ToNot(BeNil())
				Expect(result).To(BeNil())
	...
	Describe(`ListTransitGatewayGreTunnel(listTransitGatewayGreTunnelOptions *ListTransitGatewayGreTunnelOptions)`, func() {
		...
		Context(`Using mock server endpoint with timeout`, func() {
			...
			It(`Invoke ListTransitGatewayGreTunnel successfully with retries`, func() {
				...
				ctx, cancelFunc := context.WithTimeout(context.Background(), 80*time.Millisecond)
				defer cancelFunc()
				_, _, operationErr := transitGatewayApiService.ListTransitGatewayGreTunnelWithContext(ctx, listTransitGatewayGreTunnelOptionsModel)
				Expect(operationErr).ToNot(BeNil())
				Expect(operationErr.Error()).To(ContainSubstring("deadline exceeded"))
		...
		Context(`Using mock server endpoint`, func() {
			...
			It(`Invoke ListTransitGatewayGreTunnel successfully`, func() {
				...
				// Invoke operation with nil options model (negative test)
				result, response, operationErr := transitGatewayApiService.ListTransitGatewayGreTunnel(nil)
				Expect(operationErr).NotTo(BeNil())
				Expect(response).To(BeNil())
				Expect(result).To(BeNil())
			...
			It(`Invoke ListTransitGatewayGreTunnel with error: Operation validation and request error`, func() {
				...
				listTransitGatewayGreTunnelOptionsModelNew := new(transitgatewayapiv1.ListTransitGatewayGreTunnelOptions)
				// Invoke operation with invalid model (negative test)
				result, response, operationErr = transitGatewayApiService.ListTransitGatewayGreTunnel(listTransitGatewayGreTunnelOptionsModelNew)
				Expect(operationErr).ToNot(BeNil())
				Expect(response).To(BeNil())
				Expect(result).To(BeNil())
			})
	...
	Describe(`CreateTransitGatewayGreTunnel(createTransitGatewayGreTunnelOptions *CreateTransitGatewayGreTunnelOptions) - Operation response error`, func() {
		...
		Context(`Using mock server endpoint with invalid JSON response`, func() {
			...
			It(`Invoke CreateTransitGatewayGreTunnel with error: Operation response processing error`, func() {
				...
				createTransitGatewayGreTunnelOptionsModel := new(transitgatewayapiv1.CreateTransitGatewayGreTunnelOptions)
				...
				// Expect response parsing to fail since we are receiving a text/plain response
				result, response, operationErr := transitGatewayApiService.CreateTransitGatewayGreTunnel(createTransitGatewayGreTunnelOptionsModel)
				Expect(operationErr).ToNot(BeNil())
				Expect(response).ToNot(BeNil())
				Expect(result).To(BeNil())
	...
	Describe(`CreateTransitGatewayGreTunnel(createTransitGatewayGreTunnelOptions *CreateTransitGatewayGreTunnelOptions)`, func() {
		...
		Context(`Using mock server endpoint with timeout`, func() {
			...
			It(`Invoke CreateTransitGatewayGreTunnel successfully with retries`, func() {
				...
				ctx, cancelFunc := context.WithTimeout(context.Background(), 80*time.Millisecond)
				defer cancelFunc()
				_, _, operationErr := transitGatewayApiService.CreateTransitGatewayGreTunnelWithContext(ctx, createTransitGatewayGreTunnelOptionsModel)
				Expect(operationErr).ToNot(BeNil())
				Expect(operationErr.Error()).To(ContainSubstring("deadline exceeded"))
		...
		Context(`Using mock server endpoint`, func() {
			...
			It(`Invoke CreateTransitGatewayGreTunnel successfully`, func() {
				...
				// Invoke operation with nil options model (negative test)
				result, response, operationErr := transitGatewayApiService.CreateTransitGatewayGreTunnel(nil)
				Expect(operationErr).NotTo(BeNil())
				Expect(response).To(BeNil())
				Expect(result).To(BeNil())
			...
			It(`Invoke CreateTransitGatewayGreTunnel with error: Operation validation and request error`, func() {
				...
				createTransitGatewayGreTunnelOptionsModelNew := new(transitgatewayapiv1.CreateTransitGatewayGreTunnelOptions)
				// Invoke operation with invalid model (negative test)
				result, response, operationErr = transitGatewayApiService.CreateTransitGatewayGreTunnel(createTransitGatewayGreTunnelOptionsModelNew)
				Expect(operationErr).ToNot(BeNil())
				Expect(response).To(BeNil())
				Expect(result).To(BeNil())
			})
	...
	Describe(`DeleteTransitGatewayConnectionTunnels(deleteTransitGatewayConnectionTunnelsOptions *DeleteTransitGatewayConnectionTunnelsOptions)`, func() {
		...
		Context(`Using mock server endpoint`, func() {
			...
			It(`Invoke DeleteTransitGatewayConnectionTunnels successfully`, func() {
				...
				// Invoke operation with nil options model (negative test)
				response, operationErr := transitGatewayApiService.DeleteTransitGatewayConnectionTunnels(nil)
				Expect(operationErr).NotTo(BeNil())
				Expect(response).To(BeNil())

				// Construct an instance of the DeleteTransitGatewayConnectionTunnelsOptions model
				deleteTransitGatewayConnectionTunnelsOptionsModel := new(transitgatewayapiv1.DeleteTransitGatewayConnectionTunnelsOptions)
				...
				// Invoke operation with valid options model (positive test)
				response, operationErr = transitGatewayApiService.DeleteTransitGatewayConnectionTunnels(deleteTransitGatewayConnectionTunnelsOptionsModel)
				Expect(operationErr).To(BeNil())
				Expect(response).ToNot(BeNil())
			})
			It(`Invoke DeleteTransitGatewayConnectionTunnels with error: Operation validation and request error`, func() {
				...
				deleteTransitGatewayConnectionTunnelsOptionsModelNew := new(transitgatewayapiv1.DeleteTransitGatewayConnectionTunnelsOptions)
				// Invoke operation with invalid model (negative test)
				response, operationErr = transitGatewayApiService.DeleteTransitGatewayConnectionTunnels(deleteTransitGatewayConnectionTunnelsOptionsModelNew)
				Expect(operationErr).ToNot(BeNil())
				Expect(response).To(BeNil())
			})
			AfterEach(func() {
	...
	Describe(`GetTransitGatewayConnectionTunnels(getTransitGatewayConnectionTunnelsOptions *GetTransitGatewayConnectionTunnelsOptions) - Operation response error`, func() {
		...
		Context(`Using mock server endpoint with invalid JSON response`, func() {
			...
			It(`Invoke GetTransitGatewayConnectionTunnels with error: Operation response processing error`, func() {
				...
				getTransitGatewayConnectionTunnelsOptionsModel := new(transitgatewayapiv1.GetTransitGatewayConnectionTunnelsOptions)
				...
				// Expect response parsing to fail since we are receiving a text/plain response
				result, response, operationErr := transitGatewayApiService.GetTransitGatewayConnectionTunnels(getTransitGatewayConnectionTunnelsOptionsModel)
				Expect(operationErr).ToNot(BeNil())
				Expect(response).ToNot(BeNil())
				Expect(result).To(BeNil())
	...
	Describe(`GetTransitGatewayConnectionTunnels(getTransitGatewayConnectionTunnelsOptions *GetTransitGatewayConnectionTunnelsOptions)`, func() {
		...
		Context(`Using mock server endpoint with timeout`, func() {
			...
			It(`Invoke GetTransitGatewayConnectionTunnels successfully with retries`, func() {
				...
				ctx, cancelFunc := context.WithTimeout(context.Background(), 80*time.Millisecond)
				defer cancelFunc()
				_, _, operationErr := transitGatewayApiService.GetTransitGatewayConnectionTunnelsWithContext(ctx, getTransitGatewayConnectionTunnelsOptionsModel)
				Expect(operationErr).ToNot(BeNil())
				Expect(operationErr.Error()).To(ContainSubstring("deadline exceeded"))
		...
		Context(`Using mock server endpoint`, func() {
			...
			It(`Invoke GetTransitGatewayConnectionTunnels successfully`, func() {
				...
				// Invoke operation with nil options model (negative test)
				result, response, operationErr := transitGatewayApiService.GetTransitGatewayConnectionTunnels(nil)
				Expect(operationErr).NotTo(BeNil())
				Expect(response).To(BeNil())
				Expect(result).To(BeNil())
			...
			It(`Invoke GetTransitGatewayConnectionTunnels with error: Operation validation and request error`, func() {
				...
				getTransitGatewayConnectionTunnelsOptionsModelNew := new(transitgatewayapiv1.GetTransitGatewayConnectionTunnelsOptions)
				// Invoke operation with invalid model (negative test)
				result, response, operationErr = transitGatewayApiService.GetTransitGatewayConnectionTunnels(getTransitGatewayConnectionTunnelsOptionsModelNew)
				Expect(operationErr).ToNot(BeNil())
				Expect(response).To(BeNil())
				Expect(result).To(BeNil())
			})
	...
	Describe(`UpdateTransitGatewayConnectionTunnels(updateTransitGatewayConnectionTunnelsOptions *UpdateTransitGatewayConnectionTunnelsOptions) - Operation response error`, func() {
		...
		Context(`Using mock server endpoint with invalid JSON response`, func() {
			...
			It(`Invoke UpdateTransitGatewayConnectionTunnels with error: Operation response processing error`, func() {
				...
				transitGatewayTunnelPatchModel := new(transitgatewayapiv1.TransitGatewayTunnelPatch)
				...
				updateTransitGatewayConnectionTunnelsOptionsModel := new(transitgatewayapiv1.UpdateTransitGatewayConnectionTunnelsOptions)
				...
				// Expect response parsing to fail since we are receiving a text/plain response
				result, response, operationErr := transitGatewayApiService.UpdateTransitGatewayConnectionTunnels(updateTransitGatewayConnectionTunnelsOptionsModel)
				Expect(operationErr).ToNot(BeNil())
				Expect(response).ToNot(BeNil())
				Expect(result).To(BeNil())
	...
	Describe(`UpdateTransitGatewayConnectionTunnels(updateTransitGatewayConnectionTunnelsOptions *UpdateTransitGatewayConnectionTunnelsOptions)`, func() {
		...
		Context(`Using mock server endpoint with timeout`, func() {
			...
			It(`Invoke UpdateTransitGatewayConnectionTunnels successfully with retries`, func() {
				...
				ctx, cancelFunc := context.WithTimeout(context.Background(), 80*time.Millisecond)
				defer cancelFunc()
				_, _, operationErr := transitGatewayApiService.UpdateTransitGatewayConnectionTunnelsWithContext(ctx, updateTransitGatewayConnectionTunnelsOptionsModel)
				Expect(operationErr).ToNot(BeNil())
				Expect(operationErr.Error()).To(ContainSubstring("deadline exceeded"))
		...
		Context(`Using mock server endpoint`, func() {
			...
			It(`Invoke UpdateTransitGatewayConnectionTunnels successfully`, func() {
				...
				// Invoke operation with nil options model (negative test)
				result, response, operationErr := transitGatewayApiService.UpdateTransitGatewayConnectionTunnels(nil)
				Expect(operationErr).NotTo(BeNil())
				Expect(response).To(BeNil())
				Expect(result).To(BeNil())
			...
			It(`Invoke UpdateTransitGatewayConnectionTunnels with error: Operation validation and request error`, func() {
				...
				updateTransitGatewayConnectionTunnelsOptionsModelNew := new(transitgatewayapiv1.UpdateTransitGatewayConnectionTunnelsOptions)
				// Invoke operation with invalid model (negative test)
				result, response, operationErr = transitGatewayApiService.UpdateTransitGatewayConnectionTunnels(updateTransitGatewayConnectionTunnelsOptionsModelNew)
				Expect(operationErr).ToNot(BeNil())
				Expect(response).To(BeNil())
				Expect(result).To(BeNil())
			})
	...
	Describe(`ListGatewayLocations(listGatewayLocationsOptions *ListGatewayLocationsOptions) - Operation response error`, func() {
		...
		Context(`Using mock server endpoint with invalid JSON response`, func() {
			...
			It(`Invoke ListGatewayLocations with error: Operation response processing error`, func() {
				...
				listGatewayLocationsOptionsModel := new(transitgatewayapiv1.ListGatewayLocationsOptions)
				listGatewayLocationsOptionsModel.Headers = map[string]string{"x-custom-header": "x-custom-value"}
				// Expect response parsing to fail since we are receiving a text/plain response
				result, response, operationErr := transitGatewayApiService.ListGatewayLocations(listGatewayLocationsOptionsModel)
				Expect(operationErr).ToNot(BeNil())
				Expect(response).ToNot(BeNil())
				Expect(result).To(BeNil())
	...
	Describe(`ListGatewayLocations(listGatewayLocationsOptions *ListGatewayLocationsOptions)`, func() {
		...
		Context(`Using mock server endpoint with timeout`, func() {
			...
			It(`Invoke ListGatewayLocations successfully with retries`, func() {
				...
				ctx, cancelFunc := context.WithTimeout(context.Background(), 80*time.Millisecond)
				defer cancelFunc()
				_, _, operationErr := transitGatewayApiService.ListGatewayLocationsWithContext(ctx, listGatewayLocationsOptionsModel)
				Expect(operationErr).ToNot(BeNil())
				Expect(operationErr.Error()).To(ContainSubstring("deadline exceeded"))
		...
		Context(`Using mock server endpoint`, func() {
			...
			It(`Invoke ListGatewayLocations successfully`, func() {
				...
				// Invoke operation with nil options model (negative test)
				result, response, operationErr := transitGatewayApiService.ListGatewayLocations(nil)
				Expect(operationErr).NotTo(BeNil())
				Expect(response).To(BeNil())
				Expect(result).To(BeNil())
	...
	Describe(`GetGatewayLocation(getGatewayLocationOptions *GetGatewayLocationOptions) - Operation response error`, func() {
		...
		Context(`Using mock server endpoint with invalid JSON response`, func() {
			...
			It(`Invoke GetGatewayLocation with error: Operation response processing error`, func() {
				...
				getGatewayLocationOptionsModel := new(transitgatewayapiv1.GetGatewayLocationOptions)
				...
				// Expect response parsing to fail since we are receiving a text/plain response
				result, response, operationErr := transitGatewayApiService.GetGatewayLocation(getGatewayLocationOptionsModel)
				Expect(operationErr).ToNot(BeNil())
				Expect(response).ToNot(BeNil())
				Expect(result).To(BeNil())
	...
	Describe(`GetGatewayLocation(getGatewayLocationOptions *GetGatewayLocationOptions)`, func() {
		...
		Context(`Using mock server endpoint with timeout`, func() {
			...
			It(`Invoke GetGatewayLocation successfully with retries`, func() {
				...
				ctx, cancelFunc := context.WithTimeout(context.Background(), 80*time.Millisecond)
				defer cancelFunc()
				_, _, operationErr := transitGatewayApiService.GetGatewayLocationWithContext(ctx, getGatewayLocationOptionsModel)
				Expect(operationErr).ToNot(BeNil())
				Expect(operationErr.Error()).To(ContainSubstring("deadline exceeded"))
		...
		Context(`Using mock server endpoint`, func() {
			...
			It(`Invoke GetGatewayLocation successfully`, func() {
				...
				// Invoke operation with nil options model (negative test)
				result, response, operationErr := transitGatewayApiService.GetGatewayLocation(nil)
				Expect(operationErr).NotTo(BeNil())
				Expect(response).To(BeNil())
				Expect(result).To(BeNil())
			...
			It(`Invoke GetGatewayLocation with error: Operation validation and request error`, func() {
				...
				getGatewayLocationOptionsModelNew := new(transitgatewayapiv1.GetGatewayLocationOptions)
				// Invoke operation with invalid model (negative test)
				result, response, operationErr = transitGatewayApiService.GetGatewayLocation(getGatewayLocationOptionsModelNew)
				Expect(operationErr).ToNot(BeNil())
				Expect(response).To(BeNil())
				Expect(result).To(BeNil())
			})
	...
	Describe(`ListTransitGatewayConnectionPrefixFilters(listTransitGatewayConnectionPrefixFiltersOptions *ListTransitGatewayConnectionPrefixFiltersOptions) - Operation response error`, func() {
		...
		Context(`Using mock server endpoint with invalid JSON response`, func() {
			...
			It(`Invoke ListTransitGatewayConnectionPrefixFilters with error: Operation response processing error`, func() {
				...
				listTransitGatewayConnectionPrefixFiltersOptionsModel := new(transitgatewayapiv1.ListTransitGatewayConnectionPrefixFiltersOptions)
				...
				// Expect response parsing to fail since we are receiving a text/plain response
				result, response, operationErr := transitGatewayApiService.ListTransitGatewayConnectionPrefixFilters(listTransitGatewayConnectionPrefixFiltersOptionsModel)
				Expect(operationErr).ToNot(BeNil())
				Expect(response).ToNot(BeNil())
				Expect(result).To(BeNil())
	...
	Describe(`ListTransitGatewayConnectionPrefixFilters(listTransitGatewayConnectionPrefixFiltersOptions *ListTransitGatewayConnectionPrefixFiltersOptions)`, func() {
		...
		Context(`Using mock server endpoint with timeout`, func() {
			...
			It(`Invoke ListTransitGatewayConnectionPrefixFilters successfully with retries`, func() {
				...
				ctx, cancelFunc := context.WithTimeout(context.Background(), 80*time.Millisecond)
				defer cancelFunc()
				_, _, operationErr := transitGatewayApiService.ListTransitGatewayConnectionPrefixFiltersWithContext(ctx, listTransitGatewayConnectionPrefixFiltersOptionsModel)
				Expect(operationErr).ToNot(BeNil())
				Expect(operationErr.Error()).To(ContainSubstring("deadline exceeded"))
		...
		Context(`Using mock server endpoint`, func() {
			...
			It(`Invoke ListTransitGatewayConnectionPrefixFilters successfully`, func() {
				...
				// Invoke operation with nil options model (negative test)
				result, response, operationErr := transitGatewayApiService.ListTransitGatewayConnectionPrefixFilters(nil)
				Expect(operationErr).NotTo(BeNil())
				Expect(response).To(BeNil())
				Expect(result).To(BeNil())
			...
			It(`Invoke ListTransitGatewayConnectionPrefixFilters with error: Operation validation and request error`, func() {
				...
				listTransitGatewayConnectionPrefixFiltersOptionsModelNew := new(transitgatewayapiv1.ListTransitGatewayConnectionPrefixFiltersOptions)
				// Invoke operation with invalid model (negative test)
				result, response, operationErr = transitGatewayApiService.ListTransitGatewayConnectionPrefixFilters(listTransitGatewayConnectionPrefixFiltersOptionsModelNew)
				Expect(operationErr).ToNot(BeNil())
				Expect(response).To(BeNil())
				Expect(result).To(BeNil())
			})
	...
	Describe(`CreateTransitGatewayConnectionPrefixFilter(createTransitGatewayConnectionPrefixFilterOptions *CreateTransitGatewayConnectionPrefixFilterOptions) - Operation response error`, func() {
		...
		Context(`Using mock server endpoint with invalid JSON response`, func() {
			...
			It(`Invoke CreateTransitGatewayConnectionPrefixFilter with error: Operation response processing error`, func() {
				...
				createTransitGatewayConnectionPrefixFilterOptionsModel := new(transitgatewayapiv1.CreateTransitGatewayConnectionPrefixFilterOptions)
				...
				// Expect response parsing to fail since we are receiving a text/plain response
				result, response, operationErr := transitGatewayApiService.CreateTransitGatewayConnectionPrefixFilter(createTransitGatewayConnectionPrefixFilterOptionsModel)
				Expect(operationErr).ToNot(BeNil())
				Expect(response).ToNot(BeNil())
				Expect(result).To(BeNil())
	...
	Describe(`CreateTransitGatewayConnectionPrefixFilter(createTransitGatewayConnectionPrefixFilterOptions *CreateTransitGatewayConnectionPrefixFilterOptions)`, func() {
		...
		Context(`Using mock server endpoint with timeout`, func() {
			...
			It(`Invoke CreateTransitGatewayConnectionPrefixFilter successfully with retries`, func() {
				...
				ctx, cancelFunc := context.WithTimeout(context.Background(), 80*time.Millisecond)
				defer cancelFunc()
				_, _, operationErr := transitGatewayApiService.CreateTransitGatewayConnectionPrefixFilterWithContext(ctx, createTransitGatewayConnectionPrefixFilterOptionsModel)
				Expect(operationErr).ToNot(BeNil())
				Expect(operationErr.Error()).To(ContainSubstring("deadline exceeded"))
		...
		Context(`Using mock server endpoint`, func() {
			...
			It(`Invoke CreateTransitGatewayConnectionPrefixFilter successfully`, func() {
				...
				// Invoke operation with nil options model (negative test)
				result, response, operationErr := transitGatewayApiService.CreateTransitGatewayConnectionPrefixFilter(nil)
				Expect(operationErr).NotTo(BeNil())
				Expect(response).To(BeNil())
				Expect(result).To(BeNil())
			...
			It(`Invoke CreateTransitGatewayConnectionPrefixFilter with error: Operation validation and request error`, func() {
				...
				createTransitGatewayConnectionPrefixFilterOptionsModelNew := new(transitgatewayapiv1.CreateTransitGatewayConnectionPrefixFilterOptions)
				// Invoke operation with invalid model (negative test)
				result, response, operationErr = transitGatewayApiService.CreateTransitGatewayConnectionPrefixFilter(createTransitGatewayConnectionPrefixFilterOptionsModelNew)
				Expect(operationErr).ToNot(BeNil())
				Expect(response).To(BeNil())
				Expect(result).To(BeNil())
			})
	...
	Describe(`ReplaceTransitGatewayConnectionPrefixFilter(replaceTransitGatewayConnectionPrefixFilterOptions *ReplaceTransitGatewayConnectionPrefixFilterOptions) - Operation response error`, func() {
		...
		Context(`Using mock server endpoint with invalid JSON response`, func() {
			...
			It(`Invoke ReplaceTransitGatewayConnectionPrefixFilter with error: Operation response processing error`, func() {
				...
				prefixFilterPutModel := new(transitgatewayapiv1.PrefixFilterPut)
				...
				replaceTransitGatewayConnectionPrefixFilterOptionsModel := new(transitgatewayapiv1.ReplaceTransitGatewayConnectionPrefixFilterOptions)
				...
				replaceTransitGatewayConnectionPrefixFilterOptionsModel.PrefixFilters = []transitgatewayapiv1.PrefixFilterPut{*prefixFilterPutModel}
				replaceTransitGatewayConnectionPrefixFilterOptionsModel.Headers = map[string]string{"x-custom-header": "x-custom-value"}
				// Expect response parsing to fail since we are receiving a text/plain response
				result, response, operationErr := transitGatewayApiService.ReplaceTransitGatewayConnectionPrefixFilter(replaceTransitGatewayConnectionPrefixFilterOptionsModel)
				Expect(operationErr).ToNot(BeNil())
				Expect(response).ToNot(BeNil())
				Expect(result).To(BeNil())
	...
	Describe(`ReplaceTransitGatewayConnectionPrefixFilter(replaceTransitGatewayConnectionPrefixFilterOptions *ReplaceTransitGatewayConnectionPrefixFilterOptions)`, func() {
		...
		Context(`Using mock server endpoint with timeout`, func() {
			...
			It(`Invoke ReplaceTransitGatewayConnectionPrefixFilter successfully with retries`, func() {
				...
				ctx, cancelFunc := context.WithTimeout(context.Background(), 80*time.Millisecond)
				defer cancelFunc()
				_, _, operationErr := transitGatewayApiService.ReplaceTransitGatewayConnectionPrefixFilterWithContext(ctx, replaceTransitGatewayConnectionPrefixFilterOptionsModel)
				Expect(operationErr).ToNot(BeNil())
				Expect(operationErr.Error()).To(ContainSubstring("deadline exceeded"))
		...
		Context(`Using mock server endpoint`, func() {
			...
			It(`Invoke ReplaceTransitGatewayConnectionPrefixFilter successfully`, func() {
				...
				// Invoke operation with nil options model (negative test)
				result, response, operationErr := transitGatewayApiService.ReplaceTransitGatewayConnectionPrefixFilter(nil)
				Expect(operationErr).NotTo(BeNil())
				Expect(response).To(BeNil())
				Expect(result).To(BeNil())
			...
			It(`Invoke ReplaceTransitGatewayConnectionPrefixFilter with error: Operation validation and request error`, func() {
				...
				replaceTransitGatewayConnectionPrefixFilterOptionsModelNew := new(transitgatewayapiv1.ReplaceTransitGatewayConnectionPrefixFilterOptions)
				// Invoke operation with invalid model (negative test)
				result, response, operationErr = transitGatewayApiService.ReplaceTransitGatewayConnectionPrefixFilter(replaceTransitGatewayConnectionPrefixFilterOptionsModelNew)
				Expect(operationErr).ToNot(BeNil())
				Expect(response).To(BeNil())
				Expect(result).To(BeNil())
			})
	...
	Describe(`DeleteTransitGatewayConnectionPrefixFilter(deleteTransitGatewayConnectionPrefixFilterOptions *DeleteTransitGatewayConnectionPrefixFilterOptions)`, func() {
		...
		Context(`Using mock server endpoint`, func() {
			...
			It(`Invoke DeleteTransitGatewayConnectionPrefixFilter successfully`, func() {
				...
				// Invoke operation with nil options model (negative test)
				response, operationErr := transitGatewayApiService.DeleteTransitGatewayConnectionPrefixFilter(nil)
				Expect(operationErr).NotTo(BeNil())
				Expect(response).To(BeNil())

				// Construct an instance of the DeleteTransitGatewayConnectionPrefixFilterOptions model
				deleteTransitGatewayConnectionPrefixFilterOptionsModel := new(transitgatewayapiv1.DeleteTransitGatewayConnectionPrefixFilterOptions)
				...
				// Invoke operation with valid options model (positive test)
				response, operationErr = transitGatewayApiService.DeleteTransitGatewayConnectionPrefixFilter(deleteTransitGatewayConnectionPrefixFilterOptionsModel)
				Expect(operationErr).To(BeNil())
				Expect(response).ToNot(BeNil())
			})
			It(`Invoke DeleteTransitGatewayConnectionPrefixFilter with error: Operation validation and request error`, func() {
				...
				deleteTransitGatewayConnectionPrefixFilterOptionsModelNew := new(transitgatewayapiv1.DeleteTransitGatewayConnectionPrefixFilterOptions)
				// Invoke operation with invalid model (negative test)
				response, operationErr = transitGatewayApiService.DeleteTransitGatewayConnectionPrefixFilter(deleteTransitGatewayConnectionPrefixFilterOptionsModelNew)
				Expect(operationErr).ToNot(BeNil())
				Expect(response).To(BeNil())
			})
			AfterEach(func() {
	...
	Describe(`GetTransitGatewayConnectionPrefixFilter(getTransitGatewayConnectionPrefixFilterOptions *GetTransitGatewayConnectionPrefixFilterOptions) - Operation response error`, func() {
		...
		Context(`Using mock server endpoint with invalid JSON response`, func() {
			...
			It(`Invoke GetTransitGatewayConnectionPrefixFilter with error: Operation response processing error`, func() {
				...
				getTransitGatewayConnectionPrefixFilterOptionsModel := new(transitgatewayapiv1.GetTransitGatewayConnectionPrefixFilterOptions)
				...
				// Expect response parsing to fail since we are receiving a text/plain response
				result, response, operationErr := transitGatewayApiService.GetTransitGatewayConnectionPrefixFilter(getTransitGatewayConnectionPrefixFilterOptionsModel)
				Expect(operationErr).ToNot(BeNil())
				Expect(response).ToNot(BeNil())
				Expect(result).To(BeNil())
	...
	Describe(`GetTransitGatewayConnectionPrefixFilter(getTransitGatewayConnectionPrefixFilterOptions *GetTransitGatewayConnectionPrefixFilterOptions)`, func() {
		...
		Context(`Using mock server endpoint with timeout`, func() {
			...
			It(`Invoke GetTransitGatewayConnectionPrefixFilter successfully with retries`, func() {
				...
				ctx, cancelFunc := context.WithTimeout(context.Background(), 80*time.Millisecond)
				defer cancelFunc()
				_, _, operationErr := transitGatewayApiService.GetTransitGatewayConnectionPrefixFilterWithContext(ctx, getTransitGatewayConnectionPrefixFilterOptionsModel)
				Expect(operationErr).ToNot(BeNil())
				Expect(operationErr.Error()).To(ContainSubstring("deadline exceeded"))
		...
		Context(`Using mock server endpoint`, func() {
			...
			It(`Invoke GetTransitGatewayConnectionPrefixFilter successfully`, func() {
				...
				// Invoke operation with nil options model (negative test)
				result, response, operationErr := transitGatewayApiService.GetTransitGatewayConnectionPrefixFilter(nil)
				Expect(operationErr).NotTo(BeNil())
				Expect(response).To(BeNil())
				Expect(result).To(BeNil())
			...
			It(`Invoke GetTransitGatewayConnectionPrefixFilter with error: Operation validation and request error`, func() {
				...
				getTransitGatewayConnectionPrefixFilterOptionsModelNew := new(transitgatewayapiv1.GetTransitGatewayConnectionPrefixFilterOptions)
				// Invoke operation with invalid model (negative test)
				result, response, operationErr = transitGatewayApiService.GetTransitGatewayConnectionPrefixFilter(getTransitGatewayConnectionPrefixFilterOptionsModelNew)
				Expect(operationErr).ToNot(BeNil())
				Expect(response).To(BeNil())
				Expect(result).To(BeNil())
			})
	...
	Describe(`UpdateTransitGatewayConnectionPrefixFilter(updateTransitGatewayConnectionPrefixFilterOptions *UpdateTransitGatewayConnectionPrefixFilterOptions) - Operation response error`, func() {
		...
		Context(`Using mock server endpoint with invalid JSON response`, func() {
			...
			It(`Invoke UpdateTransitGatewayConnectionPrefixFilter with error: Operation response processing error`, func() {
				...
				updateTransitGatewayConnectionPrefixFilterOptionsModel := new(transitgatewayapiv1.UpdateTransitGatewayConnectionPrefixFilterOptions)
				...
				// Expect response parsing to fail since we are receiving a text/plain response
				result, response, operationErr := transitGatewayApiService.UpdateTransitGatewayConnectionPrefixFilter(updateTransitGatewayConnectionPrefixFilterOptionsModel)
				Expect(operationErr).ToNot(BeNil())
				Expect(response).ToNot(BeNil())
				Expect(result).To(BeNil())
	...
	Describe(`UpdateTransitGatewayConnectionPrefixFilter(updateTransitGatewayConnectionPrefixFilterOptions *UpdateTransitGatewayConnectionPrefixFilterOptions)`, func() {
		...
		Context(`Using mock server endpoint with timeout`, func() {
			...
			It(`Invoke UpdateTransitGatewayConnectionPrefixFilter successfully with retries`, func() {
				...
				ctx, cancelFunc := context.WithTimeout(context.Background(), 80*time.Millisecond)
				defer cancelFunc()
				_, _, operationErr := transitGatewayApiService.UpdateTransitGatewayConnectionPrefixFilterWithContext(ctx, updateTransitGatewayConnectionPrefixFilterOptionsModel)
				Expect(operationErr).ToNot(BeNil())
				Expect(operationErr.Error()).To(ContainSubstring("deadline exceeded"))
		...
		Context(`Using mock server endpoint`, func() {
			...
			It(`Invoke UpdateTransitGatewayConnectionPrefixFilter successfully`, func() {
				...
				// Invoke operation with nil options model (negative test)
				result, response, operationErr := transitGatewayApiService.UpdateTransitGatewayConnectionPrefixFilter(nil)
				Expect(operationErr).NotTo(BeNil())
				Expect(response).To(BeNil())
				Expect(result).To(BeNil())
			...
			It(`Invoke UpdateTransitGatewayConnectionPrefixFilter with error: Operation validation and request error`, func() {
				...
				updateTransitGatewayConnectionPrefixFilterOptionsModelNew := new(transitgatewayapiv1.UpdateTransitGatewayConnectionPrefixFilterOptions)
				// Invoke operation with invalid model (negative test)
				result, response, operationErr = transitGatewayApiService.UpdateTransitGatewayConnectionPrefixFilter(updateTransitGatewayConnectionPrefixFilterOptionsModelNew)
				Expect(operationErr).ToNot(BeNil())
				Expect(response).To(BeNil())
				Expect(result).To(BeNil())
			})
	...
	Describe(`ListTransitGatewayRouteReports(listTransitGatewayRouteReportsOptions *ListTransitGatewayRouteReportsOptions) - Operation response error`, func() {
		...
		Context(`Using mock server endpoint with invalid JSON response`, func() {
			...
			It(`Invoke ListTransitGatewayRouteReports with error: Operation response processing error`, func() {
				...
				listTransitGatewayRouteReportsOptionsModel := new(transitgatewayapiv1.ListTransitGatewayRouteReportsOptions)
				...
				// Expect response parsing to fail since we are receiving a text/plain response
				result, response, operationErr := transitGatewayApiService.ListTransitGatewayRouteReports(listTransitGatewayRouteReportsOptionsModel)
				Expect(operationErr).ToNot(BeNil())
				Expect(response).ToNot(BeNil())
				Expect(result).To(BeNil())
	...
	Describe(`ListTransitGatewayRouteReports(listTransitGatewayRouteReportsOptions *ListTransitGatewayRouteReportsOptions)`, func() {
		...
		Context(`Using mock server endpoint with timeout`, func() {
			...
			It(`Invoke ListTransitGatewayRouteReports successfully with retries`, func() {
				...
				ctx, cancelFunc := context.WithTimeout(context.Background(), 80*time.Millisecond)
				defer cancelFunc()
				_, _, operationErr := transitGatewayApiService.ListTransitGatewayRouteReportsWithContext(ctx, listTransitGatewayRouteReportsOptionsModel)
				Expect(operationErr).ToNot(BeNil())
				Expect(operationErr.Error()).To(ContainSubstring("deadline exceeded"))
		...
		Context(`Using mock server endpoint`, func() {
			...
			It(`Invoke ListTransitGatewayRouteReports successfully`, func() {
				...
				// Invoke operation with nil options model (negative test)
				result, response, operationErr := transitGatewayApiService.ListTransitGatewayRouteReports(nil)
				Expect(operationErr).NotTo(BeNil())
				Expect(response).To(BeNil())
				Expect(result).To(BeNil())
			...
			It(`Invoke ListTransitGatewayRouteReports with error: Operation validation and request error`, func() {
				...
				listTransitGatewayRouteReportsOptionsModelNew := new(transitgatewayapiv1.ListTransitGatewayRouteReportsOptions)
				// Invoke operation with invalid model (negative test)
				result, response, operationErr = transitGatewayApiService.ListTransitGatewayRouteReports(listTransitGatewayRouteReportsOptionsModelNew)
				Expect(operationErr).ToNot(BeNil())
				Expect(response).To(BeNil())
				Expect(result).To(BeNil())
			})
	...
	Describe(`CreateTransitGatewayRouteReport(createTransitGatewayRouteReportOptions *CreateTransitGatewayRouteReportOptions) - Operation response error`, func() {
		...
		Context(`Using mock server endpoint with invalid JSON response`, func() {
			...
			It(`Invoke CreateTransitGatewayRouteReport with error: Operation response processing error`, func() {
				...
				createTransitGatewayRouteReportOptionsModel := new(transitgatewayapiv1.CreateTransitGatewayRouteReportOptions)
				...
				// Expect response parsing to fail since we are receiving a text/plain response
				result, response, operationErr := transitGatewayApiService.CreateTransitGatewayRouteReport(createTransitGatewayRouteReportOptionsModel)
				Expect(operationErr).ToNot(BeNil())
				Expect(response).ToNot(BeNil())
				Expect(result).To(BeNil())
	...
	Describe(`CreateTransitGatewayRouteReport(createTransitGatewayRouteReportOptions *CreateTransitGatewayRouteReportOptions)`, func() {
		...
		Context(`Using mock server endpoint with timeout`, func() {
			...
			It(`Invoke CreateTransitGatewayRouteReport successfully with retries`, func() {
				...
				ctx, cancelFunc := context.WithTimeout(context.Background(), 80*time.Millisecond)
				defer cancelFunc()
				_, _, operationErr := transitGatewayApiService.CreateTransitGatewayRouteReportWithContext(ctx, createTransitGatewayRouteReportOptionsModel)
				Expect(operationErr).ToNot(BeNil())
				Expect(operationErr.Error()).To(ContainSubstring("deadline exceeded"))
		...
		Context(`Using mock server endpoint`, func() {
			...
			It(`Invoke CreateTransitGatewayRouteReport successfully`, func() {
				...
				// Invoke operation with nil options model (negative test)
				result, response, operationErr := transitGatewayApiService.CreateTransitGatewayRouteReport(nil)
				Expect(operationErr).NotTo(BeNil())
				Expect(response).To(BeNil())
				Expect(result).To(BeNil())
			...
			It(`Invoke CreateTransitGatewayRouteReport with error: Operation validation and request error`, func() {
				...
				createTransitGatewayRouteReportOptionsModelNew := new(transitgatewayapiv1.CreateTransitGatewayRouteReportOptions)
				// Invoke operation with invalid model (negative test)
				result, response, operationErr = transitGatewayApiService.CreateTransitGatewayRouteReport(createTransitGatewayRouteReportOptionsModelNew)
				Expect(operationErr).ToNot(BeNil())
				Expect(response).To(BeNil())
				Expect(result).To(BeNil())
			})
	...
	Describe(`DeleteTransitGatewayRouteReport(deleteTransitGatewayRouteReportOptions *DeleteTransitGatewayRouteReportOptions)`, func() {
		...
		Context(`Using mock server endpoint`, func() {
			...
			It(`Invoke DeleteTransitGatewayRouteReport successfully`, func() {
				...
				// Invoke operation with nil options model (negative test)
				response, operationErr := transitGatewayApiService.DeleteTransitGatewayRouteReport(nil)
				Expect(operationErr).NotTo(BeNil())
				Expect(response).To(BeNil())

				// Construct an instance of the DeleteTransitGatewayRouteReportOptions model
				deleteTransitGatewayRouteReportOptionsModel := new(transitgatewayapiv1.DeleteTransitGatewayRouteReportOptions)
				...
				// Invoke operation with valid options model (positive test)
				response, operationErr = transitGatewayApiService.DeleteTransitGatewayRouteReport(deleteTransitGatewayRouteReportOptionsModel)
				Expect(operationErr).To(BeNil())
				Expect(response).ToNot(BeNil())
			})
			It(`Invoke DeleteTransitGatewayRouteReport with error: Operation validation and request error`, func() {
				...
				deleteTransitGatewayRouteReportOptionsModelNew := new(transitgatewayapiv1.DeleteTransitGatewayRouteReportOptions)
				// Invoke operation with invalid model (negative test)
				response, operationErr = transitGatewayApiService.DeleteTransitGatewayRouteReport(deleteTransitGatewayRouteReportOptionsModelNew)
				Expect(operationErr).ToNot(BeNil())
				Expect(response).To(BeNil())
			})
			AfterEach(func() {
	...
	Describe(`GetTransitGatewayRouteReport(getTransitGatewayRouteReportOptions *GetTransitGatewayRouteReportOptions) - Operation response error`, func() {
		...
		Context(`Using mock server endpoint with invalid JSON response`, func() {
			...
			It(`Invoke GetTransitGatewayRouteReport with error: Operation response processing error`, func() {
				...
				getTransitGatewayRouteReportOptionsModel := new(transitgatewayapiv1.GetTransitGatewayRouteReportOptions)
				...
				// Expect response parsing to fail since we are receiving a text/plain response
				result, response, operationErr := transitGatewayApiService.GetTransitGatewayRouteReport(getTransitGatewayRouteReportOptionsModel)
				Expect(operationErr).ToNot(BeNil())
				Expect(response).ToNot(BeNil())
				Expect(result).To(BeNil())
	...
	Describe(`GetTransitGatewayRouteReport(getTransitGatewayRouteReportOptions *GetTransitGatewayRouteReportOptions)`, func() {
		...
		Context(`Using mock server endpoint with timeout`, func() {
			...
			It(`Invoke GetTransitGatewayRouteReport successfully with retries`, func() {
				...
				ctx, cancelFunc := context.WithTimeout(context.Background(), 80*time.Millisecond)
				defer cancelFunc()
				_, _, operationErr := transitGatewayApiService.GetTransitGatewayRouteReportWithContext(ctx, getTransitGatewayRouteReportOptionsModel)
				Expect(operationErr).ToNot(BeNil())
				Expect(operationErr.Error()).To(ContainSubstring("deadline exceeded"))
		...
		Context(`Using mock server endpoint`, func() {
			...
			It(`Invoke GetTransitGatewayRouteReport successfully`, func() {
				...
				// Invoke operation with nil options model (negative test)
				result, response, operationErr := transitGatewayApiService.GetTransitGatewayRouteReport(nil)
				Expect(operationErr).NotTo(BeNil())
				Expect(response).To(BeNil())
				Expect(result).To(BeNil())
			...
			It(`Invoke GetTransitGatewayRouteReport with error: Operation validation and request error`, func() {
				...
				getTransitGatewayRouteReportOptionsModelNew := new(transitgatewayapiv1.GetTransitGatewayRouteReportOptions)
				// Invoke operation with invalid model (negative test)
				result, response, operationErr = transitGatewayApiService.GetTransitGatewayRouteReport(getTransitGatewayRouteReportOptionsModelNew)
				Expect(operationErr).ToNot(BeNil())
				Expect(response).To(BeNil())
				Expect(result).To(BeNil())
			})
	...
	Describe(`Model constructor tests`, func() {
		Context(`Using a service client instance`, func() {
			version := "testString"
			transitGatewayApiService, _ := transitgatewayapiv1.NewTransitGatewayApiV1(&transitgatewayapiv1.TransitGatewayApiV1Options{
				URL:           "http://transitgatewayapiv1modelgenerator.com",
				Authenticator: &core.NoAuthAuthenticator{},
				Version: core.StringPtr(version),
			})
			It(`Invoke NewCreateTransitGatewayConnectionActionsOptions successfully`, func() {
				...
				createTransitGatewayConnectionActionsOptionsModel := transitGatewayApiService.NewCreateTransitGatewayConnectionActionsOptions(transitGatewayID, id, createTransitGatewayConnectionActionsOptionsAction)
			...
			It(`Invoke NewCreateTransitGatewayConnectionOptions successfully`, func() {
				...
				createTransitGatewayConnectionOptionsModel := transitGatewayApiService.NewCreateTransitGatewayConnectionOptions(transitGatewayID, createTransitGatewayConnectionOptionsNetworkType)
				...
				createTransitGatewayConnectionOptionsModel.SetPrefixFilters([]transitgatewayapiv1.TransitGatewayConnectionPrefixFilter{*transitGatewayConnectionPrefixFilterModel})
				...
				createTransitGatewayConnectionOptionsModel.SetTunnels([]transitgatewayapiv1.TransitGatewayTunnelTemplate{*transitGatewayTunnelTemplateModel})
				...
				Expect(createTransitGatewayConnectionOptionsModel.PrefixFilters).To(Equal([]transitgatewayapiv1.TransitGatewayConnectionPrefixFilter{*transitGatewayConnectionPrefixFilterModel}))
				...
				Expect(createTransitGatewayConnectionOptionsModel.Tunnels).To(Equal([]transitgatewayapiv1.TransitGatewayTunnelTemplate{*transitGatewayTunnelTemplateModel}))
			...
			It(`Invoke NewCreateTransitGatewayConnectionPrefixFilterOptions successfully`, func() {
				...
				createTransitGatewayConnectionPrefixFilterOptionsModel := transitGatewayApiService.NewCreateTransitGatewayConnectionPrefixFilterOptions(transitGatewayID, id, createTransitGatewayConnectionPrefixFilterOptionsAction, createTransitGatewayConnectionPrefixFilterOptionsPrefix)
			...
			It(`Invoke NewCreateTransitGatewayGreTunnelOptions successfully`, func() {
				...
				var createTransitGatewayGreTunnelOptionsZone transitgatewayapiv1.ZoneIdentityIntf = nil
				createTransitGatewayGreTunnelOptionsModel := transitGatewayApiService.NewCreateTransitGatewayGreTunnelOptions(transitGatewayID, id, createTransitGatewayGreTunnelOptionsLocalGatewayIp, createTransitGatewayGreTunnelOptionsLocalTunnelIp, createTransitGatewayGreTunnelOptionsName, createTransitGatewayGreTunnelOptionsRemoteGatewayIp, createTransitGatewayGreTunnelOptionsRemoteTunnelIp, createTransitGatewayGreTunnelOptionsZone)
			...
			It(`Invoke NewCreateTransitGatewayOptions successfully`, func() {
				...
				// Construct an instance of the CreateTransitGatewayOptions model
				createTransitGatewayOptionsModel := transitGatewayApiService.NewCreateTransitGatewayOptions()
				createTransitGatewayOptionsModel.SetAllowGreTrafficAcrossZones(true)
				...
				Expect(createTransitGatewayOptionsModel.AllowGreTrafficAcrossZones).To(Equal(core.BoolPtr(true)))
			...
			It(`Invoke NewCreateTransitGatewayRouteReportOptions successfully`, func() {
				// Construct an instance of the CreateTransitGatewayRouteReportOptions model
				transitGatewayID := "testString"
				createTransitGatewayRouteReportOptionsModel := transitGatewayApiService.NewCreateTransitGatewayRouteReportOptions(transitGatewayID)
			...
			It(`Invoke NewDeleteTransitGatewayConnectionOptions successfully`, func() {
				...
				transitGatewayID := "testString"
				id := "testString"
				deleteTransitGatewayConnectionOptionsModel := transitGatewayApiService.NewDeleteTransitGatewayConnectionOptions(transitGatewayID, id)
			...
			It(`Invoke NewDeleteTransitGatewayConnectionPrefixFilterOptions successfully`, func() {
				...
				id := "testString"
				filterID := "testString"
				deleteTransitGatewayConnectionPrefixFilterOptionsModel := transitGatewayApiService.NewDeleteTransitGatewayConnectionPrefixFilterOptions(transitGatewayID, id, filterID)
			...
			It(`Invoke NewDeleteTransitGatewayConnectionTunnelsOptions successfully`, func() {
				...
				deleteTransitGatewayConnectionTunnelsOptionsModel := transitGatewayApiService.NewDeleteTransitGatewayConnectionTunnelsOptions(transitGatewayID, id, greTunnelID)
			...
			It(`Invoke NewDeleteTransitGatewayOptions successfully`, func() {
				// Construct an instance of the DeleteTransitGatewayOptions model
				id := "testString"
				deleteTransitGatewayOptionsModel := transitGatewayApiService.NewDeleteTransitGatewayOptions(id)
			...
			It(`Invoke NewDeleteTransitGatewayRouteReportOptions successfully`, func() {
				...
				transitGatewayID := "testString"
				id := "testString"
				deleteTransitGatewayRouteReportOptionsModel := transitGatewayApiService.NewDeleteTransitGatewayRouteReportOptions(transitGatewayID, id)
			...
			It(`Invoke NewGetGatewayLocationOptions successfully`, func() {
				// Construct an instance of the GetGatewayLocationOptions model
				name := "testString"
				getGatewayLocationOptionsModel := transitGatewayApiService.NewGetGatewayLocationOptions(name)
			...
			It(`Invoke NewGetTransitGatewayConnectionOptions successfully`, func() {
				...
				transitGatewayID := "testString"
				id := "testString"
				getTransitGatewayConnectionOptionsModel := transitGatewayApiService.NewGetTransitGatewayConnectionOptions(transitGatewayID, id)
			...
			It(`Invoke NewGetTransitGatewayConnectionPrefixFilterOptions successfully`, func() {
				...
				id := "testString"
				filterID := "testString"
				getTransitGatewayConnectionPrefixFilterOptionsModel := transitGatewayApiService.NewGetTransitGatewayConnectionPrefixFilterOptions(transitGatewayID, id, filterID)
			...
			It(`Invoke NewGetTransitGatewayConnectionTunnelsOptions successfully`, func() {
				...
				id := "testString"
				greTunnelID := "testString"
				getTransitGatewayConnectionTunnelsOptionsModel := transitGatewayApiService.NewGetTransitGatewayConnectionTunnelsOptions(transitGatewayID, id, greTunnelID)
			...
			It(`Invoke NewGetTransitGatewayOptions successfully`, func() {
				// Construct an instance of the GetTransitGatewayOptions model
				id := "testString"
				getTransitGatewayOptionsModel := transitGatewayApiService.NewGetTransitGatewayOptions(id)
			...
			It(`Invoke NewGetTransitGatewayRouteReportOptions successfully`, func() {
				...
				transitGatewayID := "testString"
				id := "testString"
				getTransitGatewayRouteReportOptionsModel := transitGatewayApiService.NewGetTransitGatewayRouteReportOptions(transitGatewayID, id)
			...
			It(`Invoke NewListConnectionsOptions successfully`, func() {
				// Construct an instance of the ListConnectionsOptions model
				listConnectionsOptionsModel := transitGatewayApiService.NewListConnectionsOptions()
			...
			It(`Invoke NewListGatewayLocationsOptions successfully`, func() {
				// Construct an instance of the ListGatewayLocationsOptions model
				listGatewayLocationsOptionsModel := transitGatewayApiService.NewListGatewayLocationsOptions()
			...
			It(`Invoke NewListTransitGatewayConnectionPrefixFiltersOptions successfully`, func() {
				...
				transitGatewayID := "testString"
				id := "testString"
				listTransitGatewayConnectionPrefixFiltersOptionsModel := transitGatewayApiService.NewListTransitGatewayConnectionPrefixFiltersOptions(transitGatewayID, id)
			...
			It(`Invoke NewListTransitGatewayConnectionsOptions successfully`, func() {
				// Construct an instance of the ListTransitGatewayConnectionsOptions model
				transitGatewayID := "testString"
				listTransitGatewayConnectionsOptionsModel := transitGatewayApiService.NewListTransitGatewayConnectionsOptions(transitGatewayID)
			...
			It(`Invoke NewListTransitGatewayGreTunnelOptions successfully`, func() {
				...
				transitGatewayID := "testString"
				id := "testString"
				listTransitGatewayGreTunnelOptionsModel := transitGatewayApiService.NewListTransitGatewayGreTunnelOptions(transitGatewayID, id)
			...
			It(`Invoke NewListTransitGatewayRouteReportsOptions successfully`, func() {
				// Construct an instance of the ListTransitGatewayRouteReportsOptions model
				transitGatewayID := "testString"
				listTransitGatewayRouteReportsOptionsModel := transitGatewayApiService.NewListTransitGatewayRouteReportsOptions(transitGatewayID)
			...
			It(`Invoke NewListTransitGatewaysOptions successfully`, func() {
				// Construct an instance of the ListTransitGatewaysOptions model
				listTransitGatewaysOptionsModel := transitGatewayApiService.NewListTransitGatewaysOptions()
			...
			It(`Invoke NewPrefixFilterPut successfully`, func() {
				...
				_model, err := transitGatewayApiService.NewPrefixFilterPut(action, prefix)
			...
			It(`Invoke NewReplaceTransitGatewayConnectionPrefixFilterOptions successfully`, func() {
				...
				transitGatewayID := "testString"
				id := "testString"
				replaceTransitGatewayConnectionPrefixFilterOptionsPrefixFilters := []transitgatewayapiv1.PrefixFilterPut{}
				replaceTransitGatewayConnectionPrefixFilterOptionsModel := transitGatewayApiService.NewReplaceTransitGatewayConnectionPrefixFilterOptions(transitGatewayID, id, replaceTransitGatewayConnectionPrefixFilterOptionsPrefixFilters)
				...
				replaceTransitGatewayConnectionPrefixFilterOptionsModel.SetPrefixFilters([]transitgatewayapiv1.PrefixFilterPut{*prefixFilterPutModel})
				...
				Expect(replaceTransitGatewayConnectionPrefixFilterOptionsModel.PrefixFilters).To(Equal([]transitgatewayapiv1.PrefixFilterPut{*prefixFilterPutModel}))
			...
			It(`Invoke NewResourceGroupIdentity successfully`, func() {
				...
				_model, err := transitGatewayApiService.NewResourceGroupIdentity(id)
				Expect(_model).ToNot(BeNil())
				Expect(err).To(BeNil())
			})
			It(`Invoke NewTransitGatewayConnectionPrefixFilter successfully`, func() {
				action := "permit"
				prefix := "192.168.100.0/24"
				_model, err := transitGatewayApiService.NewTransitGatewayConnectionPrefixFilter(action, prefix)
				Expect(_model).ToNot(BeNil())
				Expect(err).To(BeNil())
			})
			It(`Invoke NewTransitGatewayTunnelTemplate successfully`, func() {
				...
				var zone transitgatewayapiv1.ZoneIdentityIntf = nil
				_, err := transitGatewayApiService.NewTransitGatewayTunnelTemplate(localGatewayIp, localTunnelIp, name, remoteGatewayIp, remoteTunnelIp, zone)
				Expect(err).ToNot(BeNil())
			})
			It(`Invoke NewUpdateTransitGatewayConnectionOptions successfully`, func() {
				...
				transitGatewayID := "testString"
				id := "testString"
				updateTransitGatewayConnectionOptionsModel := transitGatewayApiService.NewUpdateTransitGatewayConnectionOptions(transitGatewayID, id)
			...
			It(`Invoke NewUpdateTransitGatewayConnectionPrefixFilterOptions successfully`, func() {
				...
				id := "testString"
				filterID := "testString"
				updateTransitGatewayConnectionPrefixFilterOptionsModel := transitGatewayApiService.NewUpdateTransitGatewayConnectionPrefixFilterOptions(transitGatewayID, id, filterID)
			...
			It(`Invoke NewUpdateTransitGatewayConnectionTunnelsOptions successfully`, func() {
				...
				updateTransitGatewayConnectionTunnelsOptionsModel := transitGatewayApiService.NewUpdateTransitGatewayConnectionTunnelsOptions(transitGatewayID, id, greTunnelID, transitGatewayTunnelPatch)
			...
			It(`Invoke NewUpdateTransitGatewayOptions successfully`, func() {
				// Construct an instance of the UpdateTransitGatewayOptions model
				id := "testString"
				updateTransitGatewayOptionsModel := transitGatewayApiService.NewUpdateTransitGatewayOptions(id)
				updateTransitGatewayOptionsModel.SetID("testString")
				updateTransitGatewayOptionsModel.SetAllowGreTrafficAcrossZones(true)
				...
				Expect(updateTransitGatewayOptionsModel.AllowGreTrafficAcrossZones).To(Equal(core.BoolPtr(true)))
	...
	Describe(`Model unmarshaling tests`, func() {
		It(`Invoke UnmarshalPrefixFilterPut successfully`, func() {
			...
			model := new(transitgatewayapiv1.PrefixFilterPut)
			...
			var result *transitgatewayapiv1.PrefixFilterPut
			err = transitgatewayapiv1.UnmarshalPrefixFilterPut(raw, &result)
			Expect(err).To(BeNil())
			Expect(result).ToNot(BeNil())
		...
		It(`Invoke UnmarshalResourceGroupIdentity successfully`, func() {
			// Construct an instance of the model.
			model := new(transitgatewayapiv1.ResourceGroupIdentity)
			...
			var result *transitgatewayapiv1.ResourceGroupIdentity
			err = transitgatewayapiv1.UnmarshalResourceGroupIdentity(raw, &result)
			Expect(err).To(BeNil())
			Expect(result).ToNot(BeNil())
			Expect(result).To(Equal(model))
		})
		It(`Invoke UnmarshalTransitGatewayConnectionPrefixFilter successfully`, func() {
			// Construct an instance of the model.
			model := new(transitgatewayapiv1.TransitGatewayConnectionPrefixFilter)
			model.Action = core.StringPtr("permit")
			model.Ge = core.Int64Ptr(int64(0))
			model.Le = core.Int64Ptr(int64(32))
			model.Prefix = core.StringPtr("192.168.100.0/24")
			...
			var result *transitgatewayapiv1.TransitGatewayConnectionPrefixFilter
			err = transitgatewayapiv1.UnmarshalTransitGatewayConnectionPrefixFilter(raw, &result)
			Expect(err).To(BeNil())
			Expect(result).ToNot(BeNil())
			Expect(result).To(Equal(model))
		})
		It(`Invoke UnmarshalTransitGatewayTunnelPatch successfully`, func() {
			// Construct an instance of the model.
			model := new(transitgatewayapiv1.TransitGatewayTunnelPatch)
			...
			var result *transitgatewayapiv1.TransitGatewayTunnelPatch
			err = transitgatewayapiv1.UnmarshalTransitGatewayTunnelPatch(raw, &result)
			Expect(err).To(BeNil())
			Expect(result).ToNot(BeNil())
			Expect(result).To(Equal(model))
		})
		It(`Invoke UnmarshalTransitGatewayTunnelTemplate successfully`, func() {
			// Construct an instance of the model.
			model := new(transitgatewayapiv1.TransitGatewayTunnelTemplate)
			...
			var result *transitgatewayapiv1.TransitGatewayTunnelTemplate
			err = transitgatewayapiv1.UnmarshalTransitGatewayTunnelTemplate(raw, &result)
			Expect(err).To(BeNil())
			Expect(result).ToNot(BeNil())
			Expect(result).To(Equal(model))
		})
		It(`Invoke UnmarshalZoneIdentity successfully`, func() {
			// Construct an instance of the model.
			model := new(transitgatewayapiv1.ZoneIdentity)
			...
			var result *transitgatewayapiv1.ZoneIdentity
			err = transitgatewayapiv1.UnmarshalZoneIdentity(raw, &result)
			Expect(err).To(BeNil())
			Expect(result).ToNot(BeNil())
			Expect(result).To(Equal(model))
		})
		It(`Invoke UnmarshalZoneIdentityByName successfully`, func() {
			// Construct an instance of the model.
			model := new(transitgatewayapiv1.ZoneIdentityByName)
			model.Name = core.StringPtr("us-south-1")
			...
			var result *transitgatewayapiv1.ZoneIdentityByName
			err = transitgatewayapiv1.UnmarshalZoneIdentityByName(raw, &result)
			Expect(err).To(BeNil())
			Expect(result).ToNot(BeNil())
			Expect(result).To(Equal(model))
		})
