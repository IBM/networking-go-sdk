...
import (
	...
	"github.com/IBM/networking-go-sdk/transitgatewayapiv1"
	...
	Describe(`CreateTransitGateway(createTransitGatewayOptions *CreateTransitGatewayOptions)`, func() {
		...
		Context(`Using mock server endpoint`, func() {
			...
			It(`Invoke CreateTransitGateway with error: Operation validation and request error`, func() {
				...
				createTransitGatewayOptionsModelNew := new(transitgatewayapiv1.CreateTransitGatewayOptions)
				// Invoke operation with invalid model (negative test)
				result, response, operationErr = transitGatewayApiService.CreateTransitGateway(createTransitGatewayOptionsModelNew)
				Expect(operationErr).ToNot(BeNil())
				Expect(response).To(BeNil())
				Expect(result).To(BeNil())
			})
	...
	Describe(`Model constructor tests`, func() {
		Context(`Using a service client instance`, func() {
			...
			It(`Invoke NewCreateTransitGatewayOptions successfully`, func() {
				...
				createTransitGatewayOptionsModel := transitGatewayApiService.NewCreateTransitGatewayOptions(createTransitGatewayOptionsLocation, createTransitGatewayOptionsName)
