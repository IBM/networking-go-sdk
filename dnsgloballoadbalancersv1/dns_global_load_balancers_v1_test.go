...
var _ = Describe(`DnsGlobalLoadBalancersV1`, func() {
	var testServer *httptest.Server
    Describe(`Service constructor tests`, func() {
		It(`Instantiate service client`, func() {
			testService, testServiceErr := dnsgloballoadbalancersv1.NewDnsGlobalLoadBalancersV1(&dnsgloballoadbalancersv1.DnsGlobalLoadBalancersV1Options{
		...
		It(`Instantiate service client with error: Invalid Auth`, func() {
			testService, testServiceErr := dnsgloballoadbalancersv1.NewDnsGlobalLoadBalancersV1(&dnsgloballoadbalancersv1.DnsGlobalLoadBalancersV1Options{
				URL: "https://dnsgloballoadbalancersv1/api",
	...
	Describe(`Service constructor tests using external config`, func() {
		Context(`Using external config, construct service client instances`, func() {
			...
			var testEnvironment = map[string]string{
				"DNS_GLOBAL_LOAD_BALANCERS_URL": "https://dnsgloballoadbalancersv1/api",
				"DNS_GLOBAL_LOAD_BALANCERS_AUTH_TYPE": "noauth",
			}

			It(`Create service client using external config successfully`, func() {
				SetTestEnvironment(testEnvironment)
				testService, testServiceErr := dnsgloballoadbalancersv1.NewDnsGlobalLoadBalancersV1UsingExternalConfig(&dnsgloballoadbalancersv1.DnsGlobalLoadBalancersV1Options{
				})
				Expect(testService).ToNot(BeNil())
				Expect(testServiceErr).To(BeNil())
		...
		Context(`Using external config, construct service client instances with error: Invalid Auth`, func() {
			...
			var testEnvironment = map[string]string{
				"DNS_GLOBAL_LOAD_BALANCERS_URL": "https://dnsgloballoadbalancersv1/api",
				"DNS_GLOBAL_LOAD_BALANCERS_AUTH_TYPE": "someOtherAuth",
			}
	...
	Describe(`ListLoadBalancers(listLoadBalancersOptions *ListLoadBalancersOptions) - Operation response error`, func() {
		...
		Context(`Using mock server endpoint`, func() {
			...
			It(`Invoke ListLoadBalancers with error: Operation response processing error`, func() {
				...
				listLoadBalancersOptionsModel := new(dnsgloballoadbalancersv1.ListLoadBalancersOptions)
	...
	Describe(`ListLoadBalancers(listLoadBalancersOptions *ListLoadBalancersOptions)`, func() {
		...
		Context(`Using mock server endpoint`, func() {
			...
			It(`Invoke ListLoadBalancers with error: Operation validation and request error`, func() {
				...
				listLoadBalancersOptionsModelNew := new(dnsgloballoadbalancersv1.ListLoadBalancersOptions)
	...
	Describe(`CreateLoadBalancer(createLoadBalancerOptions *CreateLoadBalancerOptions) - Operation response error`, func() {
		...
		Context(`Using mock server endpoint`, func() {
			...
			It(`Invoke CreateLoadBalancer with error: Operation response processing error`, func() {
				...
				loadBalancerAzPoolsItemModel := new(dnsgloballoadbalancersv1.LoadBalancerAzPoolsItem)
				...
				createLoadBalancerOptionsModel := new(dnsgloballoadbalancersv1.CreateLoadBalancerOptions)
				...
				createLoadBalancerOptionsModel.AzPools = []dnsgloballoadbalancersv1.LoadBalancerAzPoolsItem{*loadBalancerAzPoolsItemModel}
	...
	Describe(`CreateLoadBalancer(createLoadBalancerOptions *CreateLoadBalancerOptions)`, func() {
		...
		Context(`Using mock server endpoint`, func() {
			...
			It(`Invoke CreateLoadBalancer with error: Operation validation and request error`, func() {
				...
				createLoadBalancerOptionsModelNew := new(dnsgloballoadbalancersv1.CreateLoadBalancerOptions)
				// Invoke operation with invalid model (negative test)
	...
	Describe(`DeleteLoadBalancer(deleteLoadBalancerOptions *DeleteLoadBalancerOptions)`, func() {
		...
		Context(`Using mock server endpoint`, func() {
			...
			It(`Invoke DeleteLoadBalancer successfully`, func() {
				...
				deleteLoadBalancerOptionsModel := new(dnsgloballoadbalancersv1.DeleteLoadBalancerOptions)
			...
			It(`Invoke DeleteLoadBalancer with error: Operation validation and request error`, func() {
				...
				deleteLoadBalancerOptionsModelNew := new(dnsgloballoadbalancersv1.DeleteLoadBalancerOptions)
				// Invoke operation with invalid model (negative test)
	...
	Describe(`GetLoadBalancer(getLoadBalancerOptions *GetLoadBalancerOptions) - Operation response error`, func() {
		...
		Context(`Using mock server endpoint`, func() {
			...
			It(`Invoke GetLoadBalancer with error: Operation response processing error`, func() {
				...
				getLoadBalancerOptionsModel := new(dnsgloballoadbalancersv1.GetLoadBalancerOptions)
	...
	Describe(`GetLoadBalancer(getLoadBalancerOptions *GetLoadBalancerOptions)`, func() {
		...
		Context(`Using mock server endpoint`, func() {
			...
			It(`Invoke GetLoadBalancer with error: Operation validation and request error`, func() {
				...
				getLoadBalancerOptionsModelNew := new(dnsgloballoadbalancersv1.GetLoadBalancerOptions)
				// Invoke operation with invalid model (negative test)
	...
	Describe(`UpdateLoadBalancer(updateLoadBalancerOptions *UpdateLoadBalancerOptions) - Operation response error`, func() {
		...
		Context(`Using mock server endpoint`, func() {
			...
			It(`Invoke UpdateLoadBalancer with error: Operation response processing error`, func() {
				...
				updateLoadBalancerOptionsModel := new(dnsgloballoadbalancersv1.UpdateLoadBalancerOptions)
				...
				updateLoadBalancerOptionsModel.AzPools = []dnsgloballoadbalancersv1.LoadBalancerAzPoolsItem{*loadBalancerAzPoolsItemModel}
	...
	Describe(`UpdateLoadBalancer(updateLoadBalancerOptions *UpdateLoadBalancerOptions)`, func() {
		...
		Context(`Using mock server endpoint`, func() {
			...
			It(`Invoke UpdateLoadBalancer with error: Operation validation and request error`, func() {
				...
				updateLoadBalancerOptionsModelNew := new(dnsgloballoadbalancersv1.UpdateLoadBalancerOptions)
				// Invoke operation with invalid model (negative test)
	...
	Describe(`ListPools(listPoolsOptions *ListPoolsOptions) - Operation response error`, func() {
		...
		Context(`Using mock server endpoint`, func() {
			...
			It(`Invoke ListPools with error: Operation response processing error`, func() {
				...
				listPoolsOptionsModel := new(dnsgloballoadbalancersv1.ListPoolsOptions)
	...
	Describe(`ListPools(listPoolsOptions *ListPoolsOptions)`, func() {
		...
		Context(`Using mock server endpoint`, func() {
			...
			It(`Invoke ListPools with error: Operation validation and request error`, func() {
				...
				listPoolsOptionsModelNew := new(dnsgloballoadbalancersv1.ListPoolsOptions)
				// Invoke operation with invalid model (negative test)
	...
	Describe(`CreatePool(createPoolOptions *CreatePoolOptions) - Operation response error`, func() {
		...
		Context(`Using mock server endpoint`, func() {
			...
			It(`Invoke CreatePool with error: Operation response processing error`, func() {
				...
				originInputModel := new(dnsgloballoadbalancersv1.OriginInput)
				...
				createPoolOptionsModel := new(dnsgloballoadbalancersv1.CreatePoolOptions)
				...
				createPoolOptionsModel.Origins = []dnsgloballoadbalancersv1.OriginInput{*originInputModel}
	...
	Describe(`CreatePool(createPoolOptions *CreatePoolOptions)`, func() {
		...
		Context(`Using mock server endpoint`, func() {
			...
			It(`Invoke CreatePool with error: Operation validation and request error`, func() {
				...
				createPoolOptionsModelNew := new(dnsgloballoadbalancersv1.CreatePoolOptions)
				// Invoke operation with invalid model (negative test)
	...
	Describe(`DeletePool(deletePoolOptions *DeletePoolOptions)`, func() {
		...
		Context(`Using mock server endpoint`, func() {
			...
			It(`Invoke DeletePool successfully`, func() {
				...
				deletePoolOptionsModel := new(dnsgloballoadbalancersv1.DeletePoolOptions)
			...
			It(`Invoke DeletePool with error: Operation validation and request error`, func() {
				...
				deletePoolOptionsModelNew := new(dnsgloballoadbalancersv1.DeletePoolOptions)
				// Invoke operation with invalid model (negative test)
	...
	Describe(`GetPool(getPoolOptions *GetPoolOptions) - Operation response error`, func() {
		...
		Context(`Using mock server endpoint`, func() {
			...
			It(`Invoke GetPool with error: Operation response processing error`, func() {
				...
				getPoolOptionsModel := new(dnsgloballoadbalancersv1.GetPoolOptions)
	...
	Describe(`GetPool(getPoolOptions *GetPoolOptions)`, func() {
		...
		Context(`Using mock server endpoint`, func() {
			...
			It(`Invoke GetPool with error: Operation validation and request error`, func() {
				...
				getPoolOptionsModelNew := new(dnsgloballoadbalancersv1.GetPoolOptions)
				// Invoke operation with invalid model (negative test)
	...
	Describe(`UpdatePool(updatePoolOptions *UpdatePoolOptions) - Operation response error`, func() {
		...
		Context(`Using mock server endpoint`, func() {
			...
			It(`Invoke UpdatePool with error: Operation response processing error`, func() {
				...
				updatePoolOptionsModel := new(dnsgloballoadbalancersv1.UpdatePoolOptions)
				...
				updatePoolOptionsModel.Origins = []dnsgloballoadbalancersv1.OriginInput{*originInputModel}
	...
	Describe(`UpdatePool(updatePoolOptions *UpdatePoolOptions)`, func() {
		...
		Context(`Using mock server endpoint`, func() {
			...
			It(`Invoke UpdatePool with error: Operation validation and request error`, func() {
				...
				updatePoolOptionsModelNew := new(dnsgloballoadbalancersv1.UpdatePoolOptions)
				// Invoke operation with invalid model (negative test)
	...
	Describe(`ListMonitors(listMonitorsOptions *ListMonitorsOptions) - Operation response error`, func() {
		...
		Context(`Using mock server endpoint`, func() {
			...
			It(`Invoke ListMonitors with error: Operation response processing error`, func() {
				...
				listMonitorsOptionsModel := new(dnsgloballoadbalancersv1.ListMonitorsOptions)
	...
	Describe(`ListMonitors(listMonitorsOptions *ListMonitorsOptions)`, func() {
		...
		Context(`Using mock server endpoint`, func() {
			...
			It(`Invoke ListMonitors with error: Operation validation and request error`, func() {
				...
				listMonitorsOptionsModelNew := new(dnsgloballoadbalancersv1.ListMonitorsOptions)
				// Invoke operation with invalid model (negative test)
	...
	Describe(`CreateMonitor(createMonitorOptions *CreateMonitorOptions) - Operation response error`, func() {
		...
		Context(`Using mock server endpoint`, func() {
			...
			It(`Invoke CreateMonitor with error: Operation response processing error`, func() {
				...
				healthcheckHeaderModel := new(dnsgloballoadbalancersv1.HealthcheckHeader)
				...
				createMonitorOptionsModel := new(dnsgloballoadbalancersv1.CreateMonitorOptions)
				...
				createMonitorOptionsModel.HeadersVar = []dnsgloballoadbalancersv1.HealthcheckHeader{*healthcheckHeaderModel}
	...
	Describe(`CreateMonitor(createMonitorOptions *CreateMonitorOptions)`, func() {
		...
		Context(`Using mock server endpoint`, func() {
			...
			It(`Invoke CreateMonitor with error: Operation validation and request error`, func() {
				...
				createMonitorOptionsModelNew := new(dnsgloballoadbalancersv1.CreateMonitorOptions)
				// Invoke operation with invalid model (negative test)
	...
	Describe(`DeleteMonitor(deleteMonitorOptions *DeleteMonitorOptions)`, func() {
		...
		Context(`Using mock server endpoint`, func() {
			...
			It(`Invoke DeleteMonitor successfully`, func() {
				...
				deleteMonitorOptionsModel := new(dnsgloballoadbalancersv1.DeleteMonitorOptions)
			...
			It(`Invoke DeleteMonitor with error: Operation validation and request error`, func() {
				...
				deleteMonitorOptionsModelNew := new(dnsgloballoadbalancersv1.DeleteMonitorOptions)
				// Invoke operation with invalid model (negative test)
	...
	Describe(`GetMonitor(getMonitorOptions *GetMonitorOptions) - Operation response error`, func() {
		...
		Context(`Using mock server endpoint`, func() {
			...
			It(`Invoke GetMonitor with error: Operation response processing error`, func() {
				...
				getMonitorOptionsModel := new(dnsgloballoadbalancersv1.GetMonitorOptions)
	...
	Describe(`GetMonitor(getMonitorOptions *GetMonitorOptions)`, func() {
		...
		Context(`Using mock server endpoint`, func() {
			...
			It(`Invoke GetMonitor with error: Operation validation and request error`, func() {
				...
				getMonitorOptionsModelNew := new(dnsgloballoadbalancersv1.GetMonitorOptions)
				// Invoke operation with invalid model (negative test)
	...
	Describe(`UpdateMonitor(updateMonitorOptions *UpdateMonitorOptions) - Operation response error`, func() {
		...
		Context(`Using mock server endpoint`, func() {
			...
			It(`Invoke UpdateMonitor with error: Operation response processing error`, func() {
				...
				updateMonitorOptionsModel := new(dnsgloballoadbalancersv1.UpdateMonitorOptions)
				...
				updateMonitorOptionsModel.HeadersVar = []dnsgloballoadbalancersv1.HealthcheckHeader{*healthcheckHeaderModel}
	...
	Describe(`UpdateMonitor(updateMonitorOptions *UpdateMonitorOptions)`, func() {
		...
		Context(`Using mock server endpoint`, func() {
			...
			It(`Invoke UpdateMonitor with error: Operation validation and request error`, func() {
				...
				updateMonitorOptionsModelNew := new(dnsgloballoadbalancersv1.UpdateMonitorOptions)
				// Invoke operation with invalid model (negative test)
	...
	Describe(`Model constructor tests`, func() {
		Context(`Using a service client instance`, func() {
			testService, _ := dnsgloballoadbalancersv1.NewDnsGlobalLoadBalancersV1(&dnsgloballoadbalancersv1.DnsGlobalLoadBalancersV1Options{
				URL:           "http://dnsgloballoadbalancersv1modelgenerator.com",
				Authenticator: &core.NoAuthAuthenticator{},
			})
			It(`Invoke NewCreateLoadBalancerOptions successfully`, func() {
				...
				createLoadBalancerOptionsModel.SetAzPools([]dnsgloballoadbalancersv1.LoadBalancerAzPoolsItem{*loadBalancerAzPoolsItemModel})
				...
				Expect(createLoadBalancerOptionsModel.AzPools).To(Equal([]dnsgloballoadbalancersv1.LoadBalancerAzPoolsItem{*loadBalancerAzPoolsItemModel}))
			...
			It(`Invoke NewCreateMonitorOptions successfully`, func() {
				...
				createMonitorOptionsModel.SetHeadersVar([]dnsgloballoadbalancersv1.HealthcheckHeader{*healthcheckHeaderModel})
				...
				Expect(createMonitorOptionsModel.HeadersVar).To(Equal([]dnsgloballoadbalancersv1.HealthcheckHeader{*healthcheckHeaderModel}))
			...
			It(`Invoke NewCreatePoolOptions successfully`, func() {
				...
				createPoolOptionsModel.SetOrigins([]dnsgloballoadbalancersv1.OriginInput{*originInputModel})
				...
				Expect(createPoolOptionsModel.Origins).To(Equal([]dnsgloballoadbalancersv1.OriginInput{*originInputModel}))
			...
			It(`Invoke NewUpdateLoadBalancerOptions successfully`, func() {
				...
				updateLoadBalancerOptionsModel.SetAzPools([]dnsgloballoadbalancersv1.LoadBalancerAzPoolsItem{*loadBalancerAzPoolsItemModel})
				...
				Expect(updateLoadBalancerOptionsModel.AzPools).To(Equal([]dnsgloballoadbalancersv1.LoadBalancerAzPoolsItem{*loadBalancerAzPoolsItemModel}))
			...
			It(`Invoke NewUpdateMonitorOptions successfully`, func() {
				...
				updateMonitorOptionsModel.SetHeadersVar([]dnsgloballoadbalancersv1.HealthcheckHeader{*healthcheckHeaderModel})
				...
				Expect(updateMonitorOptionsModel.HeadersVar).To(Equal([]dnsgloballoadbalancersv1.HealthcheckHeader{*healthcheckHeaderModel}))
			...
			It(`Invoke NewUpdatePoolOptions successfully`, func() {
				...
				updatePoolOptionsModel.SetOrigins([]dnsgloballoadbalancersv1.OriginInput{*originInputModel})
				...
				Expect(updatePoolOptionsModel.Origins).To(Equal([]dnsgloballoadbalancersv1.OriginInput{*originInputModel}))
